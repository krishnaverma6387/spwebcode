						...
						<div class="card shadow-lg" style="border-radius: 10px;">
							<div class="card-body">
								<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
									...
									<div class="float-right w-90"><input type="text" name="search" class="form-control" placeholder="Search Order " style="border:0px;border-bottom: 1px solid #F0F0F0;" ></div>
								</ul>
