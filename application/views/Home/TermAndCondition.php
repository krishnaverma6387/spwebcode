<?php 
	$list = $this->db->get("term_condition")->row();
	?>
<!DOCTYPE html>
<html class="no-js" lang="zxx">
	...
	<head>
		<meta charset="UTF-8">
		<title><?= $list->terms_title?></title>
		<meta name="description" content="<?= $list->terms_description?>">
		<meta name="keywords" content="<?= $list->terms_keyword?>">
