				...
				<div class="page-content">
					<div class="container-fluid">
						...
						<div class="row m-0 "> 
													...
													<div class="product product-7 text-center "  >  
														<figure class="product-media">  
															...
															<div class="product-action-vertical">  
																...
																<a href="javascript:void(0)" class="btn-product-icon btn-quickview btn-expandable"" title="Quick view" onclick="quickView(<?= $each->id; ?>,'Individual')" data-toggle="modal" data-target="#QuickViewModal"><span>Quick view</span></a>
															...
															<div class="container hide_in_mobile" id="app">
																...
																<div class="add-product css-1dbjc4n" style="z-index:1;">
																	...
																	<form action="<?php echo base_url($this->data->controller.'/AddToCart/Add'); ?>" method="post" enctype="multipart/form-data"  class="addForm">
																		...
																		<div class="css-1dbjc4n r-14lw9ot r-1xfd6ze r-7q8q6z r-1l7z4oj r-1m04atk r-1pyaxff r-tskmnb">
																			<div class="css-1dbjc4n r-1awozwy r-6koalj r-18u37iz r-1wtj0ep r-15zivkp r-1m04atk r-1pyaxff">
																				<div dir="auto" class="css-901oao r-cqee49" style="font-family: proxima-nova, Arial, sans-serif; font-size: 13px; font-weight: 600; letter-spacing: 0.25px; line-height: 15.6px;">Select Size</div>
																				<div class="css-1dbjc4n r-1habvwh r-6koalj r-18u37iz">
																					<div tabindex="0" class="css-1dbjc4n r-1loqt21 r-1otgn73">
																						<div class="css-1dbjc4n r-14lw9ot r-1l17iur r-1loqt21 r-1mi0q7o r-1hfyk0a r-1qfoi16 r-m611by r-lpsepz">
																							<svg width="12" height="12" viewBox="0 0 20 20" fill="none">
																								<path d="M19 1L1 19" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
																								<path d="M19 19L1 1" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
																							</svg>
																						</div>
																					</div>
																				</div>
																			...
																			<div class="css-1dbjc4n">
																				<div class="css-1dbjc4n r-150rngu r-42olwf r-z2wwpe r-rs99b7 r-eqz5dr r-16y2uox r-1wbh5a2 r-11yh6sk r-1rnoaur r-13gvty3 r-2eszeu r-1sncvnh" style="margin-bottom: 8px; overflow: visible;">
																					<div class="css-1dbjc4n">
																						<div class="css-1dbjc4n">
																							<div class="css-1dbjc4n r-18u37iz" style="justify-content: flex-start; margin-bottom: 6px; -webkit-box-pack: start;">
																								<div tabindex="0" class="css-1dbjc4n r-1loqt21 r-1otgn73" style="width: 25%;">
																									<div class="css-1dbjc4n r-1awozwy r-14lw9ot r-1dp2std r-z2wwpe r-1phboty r-rs99b7 r-6koalj r-18u37iz r-ur6pnr r-1777fci r-p1pxzi r-13hce6t r-1d4mawv r-1mnahxq r-kzbkwu r-puj83k r-11g3r6m r-ttdzmv">
																										<div dir="auto" class="css-901oao r-cqee49" style="font-family: proxima-nova, Arial, sans-serif; font-size: 13px; font-weight: 600; letter-spacing: 0.25px; line-height: 15.6px; text-align: center;">XS</div>
																									</div>
																								</div>
																								<div tabindex="0" class="css-1dbjc4n r-1loqt21 r-1otgn73" style="width: 25%;">
																									<div class="css-1dbjc4n r-1awozwy r-14lw9ot r-1dp2std r-z2wwpe r-1phboty r-rs99b7 r-6koalj r-18u37iz r-ur6pnr r-1777fci r-p1pxzi r-13hce6t r-1d4mawv r-1mnahxq r-kzbkwu r-puj83k r-11g3r6m r-ttdzmv">
																										<div dir="auto" class="css-901oao r-cqee49" style="font-family: proxima-nova, Arial, sans-serif; font-size: 13px; font-weight: 600; letter-spacing: 0.25px; line-height: 15.6px; text-align: center;">S</div>
																									</div>
																								</div>
																								<div tabindex="0" class="css-1dbjc4n r-1loqt21 r-1otgn73" style="width: 25%;">
																									<div class="css-1dbjc4n r-1awozwy r-14lw9ot r-1dp2std r-z2wwpe r-1phboty r-rs99b7 r-6koalj r-18u37iz r-ur6pnr r-1777fci r-p1pxzi r-13hce6t r-1d4mawv r-1mnahxq r-kzbkwu r-puj83k r-11g3r6m r-ttdzmv">
																										<div dir="auto" class="css-901oao r-cqee49" style="font-family: proxima-nova, Arial, sans-serif; font-size: 13px; font-weight: 600; letter-spacing: 0.25px; line-height: 15.6px; text-align: center;">M</div>
																									</div>
																								</div>
																								<div tabindex="0" class="css-1dbjc4n r-1loqt21 r-1otgn73" style="width: 25%;">
																									<div class="css-1dbjc4n r-1awozwy r-14lw9ot r-1dp2std r-z2wwpe r-1phboty r-rs99b7 r-6koalj r-18u37iz r-ur6pnr r-1777fci r-p1pxzi r-13hce6t r-1d4mawv r-1mnahxq r-kzbkwu r-puj83k r-11g3r6m r-ttdzmv">
																										<div dir="auto" class="css-901oao r-cqee49" style="font-family: proxima-nova, Arial, sans-serif; font-size: 13px; font-weight: 600; letter-spacing: 0.25px; line-height: 15.6px; text-align: center;">L</div>
																									</div>
																								</div><div tabindex="0" class="css-1dbjc4n r-1loqt21 r-1otgn73" style="width: 25%;">
																									<div class="css-1dbjc4n r-1awozwy r-14lw9ot r-1dp2std r-z2wwpe r-1phboty r-rs99b7 r-6koalj r-18u37iz r-ur6pnr r-1777fci r-p1pxzi r-13hce6t r-1d4mawv r-1mnahxq r-kzbkwu r-puj83k r-11g3r6m r-ttdzmv">
																										<div dir="auto" class="css-901oao r-cqee49" style="font-family: proxima-nova, Arial, sans-serif; font-size: 13px; font-weight: 600; letter-spacing: 0.25px; line-height: 15.6px; text-align: center;">L</div>
																									</div>
																								</div><div tabindex="0" class="css-1dbjc4n r-1loqt21 r-1otgn73" style="width: 25%;">
																						...
																						<div class="css-1dbjc4n">
																							<div class="css-1dbjc4n r-18u37iz" style="justify-content: flex-start; margin-bottom: 6px; -webkit-box-pack: start;">
																								<div tabindex="0" class="css-1dbjc4n r-1loqt21 r-1otgn73" style="width: 25%;">
																									<div class="css-1dbjc4n r-1awozwy r-14lw9ot r-1dp2std r-z2wwpe r-1phboty r-rs99b7 r-6koalj r-18u37iz r-ur6pnr r-1777fci r-p1pxzi r-13hce6t r-1d4mawv r-1mnahxq r-kzbkwu r-puj83k r-11g3r6m r-ttdzmv">
																										<div dir="auto" class="css-901oao r-cqee49" style="font-family: proxima-nova, Arial, sans-serif; font-size: 13px; font-weight: 600; letter-spacing: 0.25px; line-height: 15.6px; text-align: center;">XL</div>
																									</div>
																								</div>
																							</div>
																						</div>
																			...
																			<div tabindex="0" class="css-1dbjc4n r-1loqt21 r-1otgn73">
																				<div class="css-1dbjc4n r-1awozwy r-kemksi r-42olwf r-1l17iur r-1phboty r-rs99b7 r-1loqt21 r-i03k3n r-b5h31w r-1ah4tor r-5t7p9m" style="margin-right: 8px; margin-left: 8px;">
																					<div dir="auto" class="css-901oao r-jwli3a" style="font-family: proxima-nova, Arial, sans-serif; font-size: 13px; font-weight: 600;">Add to bag</div>
																				</div>
																			</div>
																		</div>
																		<div style="min-height:170px;  display:none; flex-direction: column; justify-content: space-evenly;">  
																			
																			<?php  
																				$data=$this->db->get_where('product_variant',array('product_id'=>$each->id))->row();
																			$Productsizes=explode(",",$data->size); ?>
																			...
																			<!--<div class="form--field product-nav-size" >
																				<?php if($Productsizes[0]!='NA'){ 
																					if(!empty($data->size_type)){
																						$sizetype=$this->db->get_where('tbl_size',array('id'=>$data->size_type))->row();
																						$AllSizes=explode(",",$sizetype->size_name); 
																						if(!empty($data->size)){
																							$count=1;
																							foreach($AllSizes as $eachsize)
																							{  
																							?> 
																							<input type="hidden" name="variantid" value="<?= $data->id ?>">  
																							<label class="sizeContainer  <?php if(!in_array($eachsize,$Productsizes)){echo 'disabled';} ?>" for="size-tile1<?=$sr;?>" ><?=$eachsize?><?php if(!in_array($eachsize,$Productsizes)){echo "<i class='bi bi-bell'></i>";} ?></label>
																							<input type="radio" class="sr-only " name="size"  id="size-tile1<?=$sr;?>" <?php if(!in_array($eachsize,$Productsizes)){echo 'disabled';} ?> value="<?=$eachsize?>" required data-parsley-required-message="Please select size">
																							<?php 
																							}
																						}
																					} 
																			...
																			<div class="product-nav-color product-nav-dots m-0 px-1">
																				<?php 
																					...
																					if(!empty($data->color)){
																						...
																						{ $uniqueId=$count.$sr;
																						?>
																						<input type="radio" name="color" id="color-tile<?= $uniqueId ?>" required class="color-item sr-only" value="<?= $color ?>" data-parsley-required-message="Please select color">
																						<label for="color-tile<?= $uniqueId ?>" class="m-0" style="height:18px; width:18px; cursor:pointer; border-radius:50%;  background:<?= $color?>"></label>
																						<?php
																							$count++;     
																						}
																					?>
																		...
																		<button type="submit" class="submit-button " style="width:75%">Add To Bag</button>
																	</form>
																</div>
																
															</div>
															
															<div class="deal-countdown offer-countdown hide_in_mobile" data-until="+11d"></div><!-- End .deal-countdown -->
														</figure><!-- End .product-media -->
														
														<div class="product-body"> 
															<h2 class="product-title"><a href="<?php echo  base_url('Home/ProductDetails/').$each->id?>"><?= $each->name; ?></a></h2><!-- End .product-title -->
															<div class="product-cat">
																<a href="<?php echo  base_url('Home/ProductDetails/').$each->id?>"><?= $each->title; ?></a>
															</div><!-- End .product-cat -->
															<div class="product-price">
																<span>₹<?= $each->off_price?></span>&nbsp;&nbsp;<del class="<?php if((int)$each->off_price==(int)$each->mrp){ echo "d-none";} ?>" style="color: gray;"><?= $each->mrp ?></del>
															...
															<div class="product-nav product-nav-dots">
																<?php 
																	...
																	if(!empty($data->color)){
																		...
																		{
																		?>
																		<a href="javascript:void(0)" class="<?php  if($count>4){echo 'MoreColor';}?>" style="background:<?= $color?>"><span class="sr-only">Color name</span></a>
																		<?php
																			$count++; 
																		}
																	?>
																	<button class="MoreColorBtn btn p-0  <?php if(count($colors)<4 || (count($colors)-4)==0){echo 'd-none';}?>" style=" border: 1px solid gray; width: 20px; margin-top: -12px; height: 20px; color:rgba(0, 0, 0, 0.71);" title="<?=(count($colors)-4)?>">+<?=(count($colors)-4)?></button>
																	<?php
																	} 
																?>
															</div><!-- End .product-nav -->
							...
							<h3 class="product-title"><a href="<?php echo  base_url('Home/ProductDetails/').$each->id?>"><?= $each->name?></a></h3><!-- End .product-title -->
							<div class="product-cat">
							<a href="<?php echo  base_url('Home/ProductDetails/').$each->id?>"><?= $each->title ?></a>
							</div><!-- End .product-cat -->
							...
							{ $uniqueId=$count.$sr;
							?>
							<input type="radio" name="color" id="color-list<?= $uniqueId ?>" required data-parsley-required-message="Please select color" class="color-item sr-only" value="<?= $color ?>">
							<label for="color-list<?= $uniqueId ?>" class="<?php  if($count>4){echo 'MoreColor';}?> m-0" style="height:18px; width:18px; cursor:pointer; border-radius:50%;  background:<?= $color?>"></label>
							<?php
							$count++;   
							}
							?>
							<a href="javascript:void(0)" class="MoreColorBtn btn p-0 <?php if(count($colors)<4 || (count($colors)-4)==0){echo 'd-none';}?>" style=" border: 1px solid gray; width: 20px; margin-top: -12px; height: 20px; color:rgba(0, 0, 0, 0.71);" title="<?=(count($colors)-4)?>">+<?=(count($colors)-4)?></a>
							<?php
							} 
							?>
							</div><!-- End .product-nav-color -->
							...
							?>
							<input type="hidden" name="variantid" value="<?= $data->id ?>">  
							<label class="sizeContainer  <?php if(!in_array('S',$sizes)){echo 'disabled';} ?>"  for="size-list1<?=$sr;?>" >S<?php if(!in_array('S',$sizes)){echo "<i class='bi bi-bell'></i>";} ?></label>
							<input type="radio" class="sr-only " name="size"  id="size-list1<?=$sr;?>" <?php if(!in_array('S',$sizes)){echo 'disabled';} ?> value="S" required data-parsley-required-message="Please select size">
							...
							<div class="filter-item <?php if($count > 10)echo "MoreFilterContent" ; ?>">
							...
							<div class="filter-item <?php if(count($category) < 11 )echo "d-none" ; ?>">
							<div class="">
							<label class="mb-0 MoreFilterBtn" for="" style="font-size: 12px;font-weight: 600; color: #FA057E; cursor:pointer;" title="<?php echo (count($category)- 10);?>">+<?php echo (count($category)- 10);?> more</label>
							</div><!-- End .custom-checkbox -->
							</div><!-- End .filter-item -->
							<?php } ?>
							...
							<!--for show more filter content don't delete start-->
							<div class="showMoreContainer">   
							<div class="filter-item MoreFilterContent">
							<div class="custom-control custom-checkbox">
							<input type="checkbox" class="custom-control-input common-selector size" value="XXXL" id="cat-8">
							<label class="custom-control-label" for="cat-8">XXXL</label>
							</div><!-- End .custom-checkbox -->
							...
							<div class="filter-item">
							<div class="">
							<label class="mb-0 MoreFilterBtn" for="" style="font-size: 12px;font-weight: 600; color: #FA057E; cursor:pointer;" title="1">+1more</label>
							</div><!-- End .custom-checkbox -->
							</div><!-- End .filter-item -->
							</div>
							<!--for show more filter content don't delete end-->
							</div><!-- End .filter-items -->
							</div><!-- End .widget-body -->
							</div><!-- End .collapse -->
							</div><!-- End .widget -->
							...
							<div class="filter-item <?php if(count($brands) < 11 )echo "d-none" ; ?>">
							<div class="">
							<label class="mb-0 MoreFilterBtn" for="" style="font-size: 12px;font-weight: 600; color: #FA057E; cursor:pointer;" title="<?php echo (count($brands)- 10);?>">+<?php echo (count($brands)- 10);?> more</label>
							</div><!-- End .custom-checkbox -->
							</div><!-- End .filter-item -->
							<?php } ?>
							</div><!-- End .filter-items -->
							...
							<div class="filter-item <?php if(count($colors) < 11 ){echo "d-none" ;} ?>">
							<div class="">
							<label class="mb-0 MoreFilterBtn" for="" style="font-size: 12px;font-weight: 600; color: #FA057E; cursor:pointer;" title="<?php echo (count($colors)- 10);?>">+<?php echo (count($colors)- 10);?> more</label>
							</div><!-- End .custom-checkbox -->
							</div><!-- End .filter-item -->
							<?php } ?>
