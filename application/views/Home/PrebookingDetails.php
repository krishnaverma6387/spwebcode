											...
											<div class="product-gallery product-gallery-vertical ">
												...
												<div class="row hide_in_mobile">  
													...
													<figure class="product-main-image mb-1 ">
														<img id="product-zoom" src="<?= base_url('uploads/product/') . $icons[0]; ?>" data-zoom-image="<?= base_url('uploads/product/') . $icons[0]; ?>" alt="product image">
													...
													<div id="product-zoom-gallery" class="product-image-gallery vertical-slider" style="border:1px solid bloack;">
														<?php
															...
															<a class="product-gallery-item <?php if($count==1){echo "active";}?>" href="#" data-image="<?= base_url('uploads/product/') . $each; ?>" data-zoom-image="<?= base_url('uploads/product/') . $each; ?>">
																<img src="<?= base_url('uploads/product/') . $each; ?>"  alt="product side">
															</a>
															<?php
															$count++;}
														?>
														...
														<div class="intro-slider-container">
															<div class="single-giftwraping owl-carousel owl-theme owl-nav-inside owl-light" >		
																...
																<?php
																	...
																	foreach ($icons as $each) { 
																	?>
																	<img src="<?= base_url('uploads/product/') . $each; ?>"  alt="product side" style="height:420px !important;">
																	<?php
																	$count++;}
																?>
										...
										<div class="row">
											<?php 
												...
												if($this->subscription=='true'){ 
													...
													$launch_time=date('Y-m-d h:i',strtotime($prev_days,strtotime($list->launch_time)));
												}
												else{ 
													$launch_time=date('Y-m-d h:i',strtotime($list->launch_time));
												} 
											...
											<div class="col-sm-12 col-12 pb-2"> 
												<div class="d-flex justify-content-between pro-desc">
													...
													<div class="w-100">
													<span class="alert my-1" style="color:#e81515!important; background-color:lightpink;border:none !important;  font-weight:600; padding:0px 2px !important;" role="alert">Prebooking</span>
													<span style="color:#a7a0a0 !important; border:none !important;  font-weight:600; padding:5px !important;  padding-left:0px !important;">&nbsp;Launch in:</span> 
													...
													<span class="mb-2">Prebooking at just ₹<?=(int)$list->prebook_amt;?>&nbsp;<i class="bi bi-info-circle-fill" data-toggle="popover-hover" data-content="You can purchase this product at ₹<?=(int)$list->prebook_amt;?> , rest amount ₹<?php echo ((int)$list->reg_sell_price-(int)$list->prebook_amt);?> you have to pay before the delivery date otherwise your order will be canceled" data-placement="top" style="cursor:pointer; font-size: 14px; color: grey;"></i></span></br>
													<?php } ?>  
													...
													<div class="col-lg-8 col-sm-10 col-12 couponBox border-bottom" style="min-height:70px; border-radius:0;">  
													<div class="d-flex">
													<div class="col-2 p-0 pb-2"> 
													<img src="<?= base_url('public/images/royaldelivery.png')?>" style="width:60px !important;" />
													</div>
													...
													<?php }else{ ?> 
													<strong style="font-size: 14px;">Royal Club Price:<span>₹<?php  echo $list->royal_amt;?></span></strong>
													<?php } ?>
													...
													<form action="<?php echo base_url($this->data->controller . '/Prebooking/Add'); ?>" method="post" enctype="multipart/form-data" id="CheckOutForm2">
													<input type="hidden" required name="productid" value="<?= $list->id; ?>">
													<!--select image start--> 
													<div class="row m-0 mt-2 mb-1">
													<div class="col-sm-8 col-12  border-bottom">
													...
													<img src="<?= base_url('uploads/product/') . $icons[0]; ?>"  style="height:100%;"> 
													</label>     
													</a>
													<?php
													}else{ ?>
													...
													?>
													<div class="row pt-0">
													<span class="col-sm-8 col-12 d-flex  justify-content-between">   
													...
													<span class="size-buttons-inventory-left <?php if($size_stock<=5 AND $size_stock > 0){echo 'd-block';}else{echo 'd-none';}?>" style="bottom:18px;"><?= $size_stock;?>&nbsp;left</span>
													</span> 
													<?php
													}
													$count++; 
													...
													<div class="row m-0 my-2 mt-3" id="absoluteButton">  
													<div class="col-sm-8 p-0 col border-bottom" id="phoneFixedButton">
													<?php
													$json=json_decode($variants->size);
													$count = 0;
													...
													?>
													<span id="" class="btn btn-secondary customBtn1 size-buttons-size-button-disabled text-uppercase disabled w-100" style="font-weight:600; background: #d5d6d9 !important;"><i class='bi bi-bell'></i>Out of Stock</span>
													<?php }else{ ?>
													<?php 
													if($this->permission=='true'){
													$userid=$this->userData->id;
													$address=$this->db->get_where('tbl_address',['userid'=>$userid,'default_address'=>'true'])->row();
													if(!empty($address)){
													?>
													<div class="row mx-0 mt-1 mb-3 mobile-top-border">
													<div class="col-sm-12 p-3 address-details d-flex justify-content-between">
													<input type="hidden" class="customradio" id="UserName2" name="address" data-parsley-required-message="Please select address" required value="<?= $address->id?>">
													<div class="box-left">
													<p><i class="bi bi-house-door"></i>&nbsp;<span>Deliver to <b style="font-weight:500;"><?= $address->name?></b> <span class="hide_in_mobile">(<?=$address->address_type?>)</span></span></p> 
													<p><span><?=ucfirst($address->line1)?>,<?=ucfirst($address->state)?></span></p> 
													<p><b style="font-weight:500;"><?= ucfirst($address->city)?> - <?= $address->pincode?></b></p>
													</div> 
													...
													<?php }else{ ?> 
													<div class="row mx-0 mt-1 mb-3 mobile-top-border">
													<div class="col-sm-12 p-2 address-details d-flex justify-content-between">
													
													<div class="box-left">
													<p><a href="javascript:void(0)" onclick="OpenAddressModal()"  style="height: 100%; width: 100%; display: block; color:#8834AD; font-weight:600;">Add New Address(<i class="bi bi-plus font-weight-bold"></i>)</a></p> 
													<input type="radio" class="customradio sr-only" id="UserName2" name="address" data-parsley-required-message="Please select address" required value="">
													</div> 
													</div>
													</div>     
													<?php } }?>
													<button id="CheckOutBtn2" class="btn btn-secondary customBtn1 w-100"><i class="bi bi-bag-plus"></i>Prebook&nbsp;<i class="fa fa-spin fa-spinner" id="CheckOutSpin2" style="display:none;"></i></button>
													<?php } ?>
													</div>
													</div> 
													...
													<img src="<?= base_url('uploads/coupon/'.$coupon->banner) ?>" style="width:80px !important;" />
													</div>
													...
													<img src="<?= base_url('uploads/plan/'.$benefits->icon)?>" style="width:100px !important;" />
													...
													<div class="col-sm-12">
													<div class="p-3">
													<h6 style="font-weight:900">Easy Exchange & Return&nbsp;<span style="font-size: 14px;font-weight: 500;color: gray;">(how it works?)</span></h6><a href="javascript:void(0)" class="closebtn" onclick="closePrivacyNav()">&times;</a>
													<br>
													...
													<!-- addressaddress add modal start-->
													<div class="modal fade" id="AddAddress" tabindex="-1" role="dialog"  aria-hidden="true" style="background:#1e1e1eb5;">
													...
													<div class="form-group">
													<label style="color: black; font-size: 14px; font-weight: 600;">Shipping details will be sent to: <span class="text-danger">*</span></label> 
													...
													<div class="form-group">
													<label style="color: black; font-size: 14px; font-weight: 600;">Choose State <span class="text-danger" style="color: black; font-size: 14px; font-weight: 600;">*</span></label>
													...
													<div class="form-group">
													<label style="color: black; font-size: 14px; font-weight: 600;">Choose City <span class="text-danger" style="color: black; font-size: 14px; font-weight: 600;">*</span></label>
													<select id ="state" name="city" class="form-control" required data-parsley-required-message="Please select city">
													<option selected disabled>Select City</option>	
													</select>
													</div>
													<div class="form-group"> 
													<label style="color: black; font-size: 14px; font-weight: 600;">Pin Code <span class="text-danger" style="color: black; font-size: 14px; font-weight: 600;">*</span></label> 
													...
													<div class="form-group">
													<label style="color: black; font-size: 14px; font-weight: 600;">Flat/House No./Building<span class="text-danger">*</span></label> 
													...
													<div class="form-group">
													<label style="color: black; font-size: 14px; font-weight: 600;">Area/Locality<span class="text-danger">*</span></label> 
													...
													<div class="form-group">
													<label style="color: black; font-size: 14px; font-weight: 600;">Landmark<span class="text-danger">(Optional)</span></label> 
													<input type="text" name="addressline3" class="form-control"  placeholder="Landmark" >
													</div>
													<div class="form-group">
													<label style="color: black; font-size: 14px; font-weight: 600;">Mobile No<span class="text-danger">*</span></label> 
													...
													<div class="form-group">
													<label style="color: black; font-size: 14px; font-weight: 600;">Alternate No.<span class="text-danger">(optional)</span></label> 
													...
													<div class="form-group">
													<label style="color: black; font-size: 14px; font-weight: 600;">Address Type<span class="text-danger">*</span></label>  <br>
													...
													<div class="form-group">
													<input type="checkbox" name="defaultaddress" for="" checked id="chebox" >
													<label for="chebox" style="color: black; font-size: 14px; font-weight: 600;">Use this as your Default Address<span class="text-danger"></span></label> 
													</div>
													...
													<div class="modal fade" id="AddressModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background: rgba(30, 30, 30, 0.71);">
													<div class="modal-dialog modal-dialog-scrollable" role="document">
													<div class="modal-content">
													<div class="modal-header bg-gray">
													...
													<?php
													$userid=$this->userData->id;
													$addresslist=$this->db->get_where('tbl_address',['userid'=>$userid])->result();
													...
													<button type="submit" <?php if(!empty($addresslist) AND count($addresslist)<2){echo 'disabled';}?> class="btn btn-secondary" class="addBtn">Deliver Here<i class="fa fa-spin fa-spinner" id="addSpin" style="display:none;"></i></button>
													</div>
													</div> 
													</div> 
													</div>
													...
													url=response[0].data.baseUrl+'Home/Prebooking/PaymentResponse/'+rzpResponse.razorpay_order_id+'/'+rzpResponse.razorpay_payment_id;
													$.ajax({
													url: url,
													type: "post",
													data: {
