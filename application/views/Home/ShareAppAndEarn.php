			...
			<div class="container">
				<div class="row" id="main-sec" >
					...
					<div class="col-sm-12 text-center text-white">
						<h1 class="text-center">Refer App & Earn</h1>	
						<p class="text-center">Refer App With Friends & Earn <?php if(!empty($refer_reward->first_order)){echo $refer_reward->first_order;}?> Slick Pattern Points For Every Friend</p>
					</div>
					<div class="col-sm-8 mx-auto">
						<div class="card " style="border:0px;">
							<div class="card-body" style="padding-top:0px;" >
								<center><img src="<?=base_url('public/images/share_earn_app.jpg')?>" class="img-fluid"></center> 
							</div> 
						</div>   
					</div> 
