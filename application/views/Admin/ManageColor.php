            ...
            <div class="content-wrapper">
				...
				<?php 
                    ...
                    if(!empty($this->permissionAuth) && ($this->userData->type=='subadmin')){
						$permission=$this->permissionAuth->color;
						$role_type='subadmin';
					}
				?>
                                                        ...
                                                        <?php $srno=1; foreach ($list as $item){ ?>
                                                            <tr>
                                                               ...
                                                               <?php if(($role_type=='subadmin' && $permission->approval) || $role_type=='admin'){?>
																...
																<?php } ?>
                                                                <td><?= $item->name; ?></td>
                                                                <td><div class="d-flex"><span style="padding:4px;display:block;background:<?= $item->code; ?>;width:15px;height:15px;border-radius:25px;box-shadow: 0px 0px 0px 3px #dbdbdb;"></span>&nbsp;&nbsp;<?= $item->code; ?></div></td>  
                                    ...
                                    <div class="modal-body p-1">
                                        ...
                                        value="<?= $this->security->get_csrf_hash(); ?>" />
                                      	<div class="form-group">
											...
											<input type="text" class="form-control demoInputBox " name="name"  title="Please Choose a Name" required >
										</div>
										<div class="form-group">
											<label for="input-2">Color<span class="text-danger">*</span></label>
											<input type="color" id="style2" class="form-control demoInputBox " name="code"  title="Please Choose a Color" required >
										</div>
