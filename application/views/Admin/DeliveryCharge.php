            ...
            <div class="content-wrapper">
				...
				<?php 
                    ...
                    if(!empty($this->permissionAuth) && ($this->userData->type=='subadmin')){
						$permission=$this->permissionAuth->deliverycharge;
						$role_type='subadmin';
					}
				?>
                                ...
                                <div class="card card-dashboard">
									<?php if(($role_type=='subadmin' && $permission->add) || $role_type=='admin'){?>
										<div class="card-header p-1">
											...
											<a href="<?= base_url('uploads/excel/DemoExcelSheetPincode.xlsx');?>" class="btn btn-secondary"  > <i class="fa fa-download" aria-hidden="true"></i> Demo File</a>
										</div>
									<?php } ?>
                                            ...
                                            <div class="">
                                                <table class="table table-striped table-bordered dataex-res-configuration" style="width:100%;">
                                                    ...
                                                    <tbody>
														...
														<input type="number" class="form-control text-capitalize" minlength="6" maxlength="6" name="pincode" placeholder="Enter Area Pincode" required >
														<?php echo form_error("pincode", "<p class='text-danger' >", "</p>"); ?>
														</div>
														<div class="form-group">
														<label class="col-form-label">Area<span class="text-danger">*</span></label>
														<input type="text" class="form-control text-capitalize" name="area" placeholder="Enter Pincode Area Name" required >
														...
														<input type="number" class="form-control text-capitalize" name="charge" placeholder="Enter Charge" required >
														<?php echo form_error("charge", "<p class='text-danger' >", "</p>"); ?>
														</div>
														<div class="form-group">
														<label class="col-form-label">Description <span class="text-danger">*</span></label>
														<textarea class="form-control text-capitalize" name="description" placeholder="Description" required></textarea>
														...
														<h5 class="modal-title text-white">Upload Delivery Pincodes</h5>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close">
														<span aria-hidden="true">&times;</span>
														</button>
														</div>
