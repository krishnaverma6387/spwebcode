														...
														<div class="card-content">
															<div class="card-body">
																<ul class="nav nav-tabs nav-underline no-hover-bg" role="tablist">
																	<li class="nav-item">
																		<a class="nav-link active" id="base-tab31" data-toggle="tab" aria-controls="tab31" href="#tab31" role="tab" aria-selected="true">Top Become Seller</a>
																	</li>
																	<li class="nav-item">
																		<a class="nav-link" id="base-tab32" data-toggle="tab" aria-controls="tab32" href="#tab32" role="tab" aria-selected="false">Bottom Become Seller</a>
																	</li>
																</ul>
																				...
																				<div class="card card-dashboard">
																					<div class="card-content collpase show">
																						<div class="card-header p-1">
																							...
																							<i class="fa fa-plus-circle" aria-hidden="true"></i> Add Top </button>
																						</div>
																						<div class="card-body table-responsive">
																							<div class="">
																														...
																														<td>
																															<div class="btn-group">
																																...
																																<?php if (($role_type == 'subadmin' && $permission->delete) || $role_type == 'admin') { ?>
																																	<a href="javascript:void(0);" class="btn btn-sm btn-outline-danger waves-effect waves-light" onclick="return Delete(this,'tbl_stayconnecttop','id','<?= $item->id; ?>','<?= $this->data->folder; ?>','<?= $this->data->file_column; ?>')"> <i class="fa fa-trash"></i> </a>
																																<?php } ?>
																															</div>
																														</td>
																													<?php } ?>
																				...
																				<div class="card card-dashboard">
																					<div class="card-content collpase show">
																						<div class="card-header p-1">
																							...
																							<i class="fa fa-plus-circle" aria-hidden="true"></i> Add Bottom </button>
																						</div>
																						<div class="card-body table-responsive">
																							<div class="">
																								<table class="table table-striped table-bordered dataex-res-configuration" style="width:100%;">
																									...
																									<tbody>
																										<?php 
																											if(!empty($bottom_seller))
																											{
																												$srno=1; 
																												foreach ($bottom_seller as $item)
																												{ 
																												?>
																												<tr>
																													<td><?= $srno; ?></td>
																													...
																													<?php if(($role_type=='subadmin' && $permission->edit) || ($role_type=='subadmin' && $permission->delete) || $role_type=='admin'){?>
																														<td>
																															<div class="btn-group">
																																...
																																<?php } ?>
																																<?php if(($role_type=='subadmin' && $permission->delete) || $role_type=='admin'){?>
																																	<a href="javascript:void(0);"  class="btn btn-sm btn-outline-danger waves-effect waves-light" onclick="return Delete(this,'tbl_becomeseller','id','<?= $item->id; ?>','<?= $this->data->folder; ?>','<?= $this->data->file_column1; ?>')"> <i class="fa fa-trash"></i> </a>
																																<?php } ?>
																															</div>
																														</td>
																													<?php } ?>
