																...
																<div class="row">
																	...
																	<div class="col-sm-12">
																		<div class="form-group">
																			...
																			<textarea id="summernoteEditor" name="intellectual_property" class="form-control summernote">
																				<?php echo !empty($list->intellectual_property) ? $list->intellectual_property : '' ?>
																			</textarea>
																		</div>
																	</div>
																</div>
