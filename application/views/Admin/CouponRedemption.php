                                                ...
                                                <div class="card-body py-1 px-0 table-responsive">
                                                    <div class="offcanvas-body">
                                                        <div class="container-fluid">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <h1><span class="badge badge-secondary">Coupon Redemption</span></h1>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="coupon_title" class="form-control">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="coupon_description" class="form-control">
