																	...
																	<td>
																		<div class="btn-group">
																			...
																			<?php if (($role_type == 'subadmin' && $permission->delete) || $role_type == 'admin') { ?>
																				<a href="javascript:void(0);" class="btn btn-sm btn-outline-danger waves-effect waves-light" onclick="return Delete(this,'tbl_about','id','<?= $item->id; ?>','<?= $this->data->folder; ?>','<?= $this->data->file_column; ?>')"> <i class="fa fa-trash"></i> </a>
																			<?php } ?>
																		</div>
																	</td>
																<?php } ?>
								...
								<form action="<?php echo base_url($this->data->controller . '/' . $this->data->method . '/Add'); ?>" method="post" enctype="multipart/form-data">
									<div class="modal-body p-1">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="alt5" placeholder="Image Alt5" required >
										</div>
										
										<div class="form-group">
											<label class="col-form-label">Image Title5 <span class="text-danger">*</span></label>
											<input type="text" class="form-control" name="seo_title5" placeholder="Image Title5" required>
										</div>
										...
										<div class="form-group">
											...
											<textarea id="summernoteEditor" name="meta_description" class="form-control summernote"></textarea>
										</div>
										
										<div class="form-group">
											<label class="col-form-label">Meta Keyword <span class="text-danger">*</span></label>
											<textarea id="summernoteEditor" name="meta_keyword" class="form-control summernote"></textarea>
										</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="title4" placeholder="Founder Name" required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<textarea id="summernoteEditor" name="desc6" class="form-control summernote"></textarea>
										</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="title7" placeholder="Title7" required>
										</div>
										
										<div class="form-group">
											<label class="col-form-label">Description7 <span class="text-danger">*</span></label>
											<textarea id="summernoteEditor" name="desc7" class="form-control summernote"></textarea>
										</div>
										<div class="form-group">
											<label class="col-form-label">Title8 <span class="text-danger">*</span></label>
											<input type="text" class="form-control" name="title8" placeholder="Title8" required>
										</div>
										
										<div class="form-group">
											<label class="col-form-label">Description8 <span class="text-danger">*</span></label>
											<textarea id="summernoteEditor" name="desc8" class="form-control summernote"></textarea>
										</div>
										<div class="form-group">
											<label class="col-form-label">Title9 <span class="text-danger">*</span></label>
											<input type="text" class="form-control" name="title9" placeholder="Title9" required>
										</div>
										...
										<div class="form-group">
											...
											<textarea id="summernoteEditor" name="desc9" class="form-control summernote"></textarea>
										</div>
									</div>
