																...
																<?php if (($role_type == 'subadmin' && $permission->approval) || $role_type == 'admin') { ?>
																	<td>
																		<div class="custom-control custom-switch custom-control-inline">
																			<input type="checkbox" class="custom-control-input" onchange="return Status(this,'tbl_getapp','id','<?= $item->id; ?>','is_status')" <?php if ($item->is_status == 'true') {
																				echo 'checked';
																			} ?> id="switch-id<?= $srno; ?>">
																	...
																	<td>
																		<div class="btn-group">
																			...
																			<?php if (($role_type == 'subadmin' && $permission->delete) || $role_type == 'admin') { ?>
																				<a href="javascript:void(0);" class="btn btn-sm btn-outline-danger waves-effect waves-light" onclick="return Delete(this,'tbl_getapp','id','<?= $item->id; ?>','<?= $this->data->folder; ?>','<?= $this->data->file_column; ?>')"> <i class="fa fa-trash"></i> </a>
																			<?php } ?>
																		</div>
																	</td>
																<?php } ?>
								...
								<form action="<?php echo base_url($this->data->controller . '/' . $this->data->method . '/Add'); ?>" method="post" enctype="multipart/form-data">
									<div class="modal-body p-1">
										...
										<div class="form-group">
											<label for="exampleFormControlTextarea1"><h3>GETAPP TITLE</h3></label>
										...
										<div class="form-group">
											<label for="exampleFormControlTextarea1"><h3>GETAPP DESCRIPTION</h3></label>
										...
										<div class="form-group">
											<label for="exampleFormControlTextarea1"><h3>GETAPP KEYWORD</h3></label>
										...
										<div class="form-group">
											<label for="exampleFormControlTextarea1"><h3>GETAPP Heading</h3></label>
