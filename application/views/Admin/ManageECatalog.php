			...
			<div class="content-wrapper">
				...
				<?php 
                    ...
                    if(!empty($this->permissionAuth) && ($this->userData->type=='subadmin')){
						$permission=$this->permissionAuth->ecatlog;
						$role_type='subadmin';
					}
				?>
													...
													<tbody>
														...
														<?php $srno = 1;
															...
															<tr>
																...
																<td>
																<label data-toggle="tooltip" data-placement="top" title="ID: <?= $item->id; ?>"><a href="<?= base_url('uploads/' . $this->data->folder . '/' . $item->catalog); ?>" target="_blank"><iframe src="<?= base_url('uploads/' . $this->data->folder . '/' . $item->catalog); ?>" style=" width:250px;" /></iframe></a></label>
																</td>
																...
																<input type="file" class="form-control " name="catalog" Title="Choose" accept="application/pdf" required>
