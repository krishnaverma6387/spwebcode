																...
																<div class="row">
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label for="exampleFormControlTextarea1"><h3>CANCELLATIONS TITLE</h3></label>
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label for="exampleFormControlTextarea1"><h3>CANCELLATIONS DESCRIPTION</h3></label>
																	...
																	<div class="col-sm-12">
																		<div class="form-group">
																			<label for="exampleFormControlTextarea1"><h3>CANCELLATIONS KEYWORD</h3></label>
																	...
																	<div class="col-sm-12">
																		<div class="form-group">
																			<label for="exampleFormControlTextarea1"><h3>CANCELLATIONS POLICY</h3></label>
																	...
																	<div class="col-sm-12">
																		<div class="form-group">
																			<label for="exampleFormControlTextarea1"><h3>CANCELLATIONS POLICY 2</h3></label>
																			<textarea id="summernoteEditor" name="cancellation_policy2" class="form-control summernote">
																				<?php echo !empty($list->cancellation_policy2) ? $list->cancellation_policy2 : '' ?>
																			</textarea>
																		</div>
																	</div>
