																	...
																	<td>
																		<div class="btn-group">
																			...
																			<?php if (($role_type == 'subadmin' && $permission->delete) || $role_type == 'admin') { ?>
																				<a href="javascript:void(0);" class="btn btn-sm btn-outline-danger waves-effect waves-light" onclick="return Delete(this,'tbl_paymentmethod','id','<?= $item->id; ?>','<?= $this->data->folder; ?>','<?= $this->data->file_column; ?>')"> <i class="fa fa-trash"></i> </a>
																			<?php } ?>
																		</div>
																	</td>
																<?php } ?>
								...
								<form action="<?php echo base_url($this->data->controller . '/' . $this->data->method . '/Add'); ?>" method="post" enctype="multipart/form-data">
									<div class="modal-body p-1">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="payment_title" placeholder="Payment Method Title" required>
										</div>
										<div class="form-group">
											<label class="col-form-label">Payment Method Description<span class="text-danger">*</span></label>
											<input type="text" class="form-control" name="payment_description" placeholder="Payment Method Description" required>
										</div>
										<div class="form-group">
											<label class="col-form-label">Payment Method Keyword<span class="text-danger">*</span></label>
											<input type="text" class="form-control" name="payment_keyword" placeholder="Payment Method Keyword" required>
										</div>
