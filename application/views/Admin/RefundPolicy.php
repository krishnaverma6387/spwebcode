														...
														<div class="offcanvas-body">
															<div class="container-fluid">
																...
																<div class="row">
																	...
																	<div class="col-sm-12">
																		<div class="form-group">
																			<label for="exampleFormControlTextarea1"><h3>REFUND POLICY 2</h3></label>
																			<textarea id="summernoteEditor" name="refund_policy2" class="form-control summernote">
																				<?php echo !empty($list->refund_policy2) ? $list->refund_policy2 : '' ?>
																			</textarea>
																		</div>
																	</div>
