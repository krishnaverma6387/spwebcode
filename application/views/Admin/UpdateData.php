...
?>
		...
		<?php
			...
			// EditStayConnectedp 
		case 'EditStayConnected':
		?>
			<input type="hidden" name="id" value="<?php echo $list[0]->id; ?>" />

			<div class="form-group">
				<labeel class="col-form-label">Link <span class="text-danger">*</span></label>
					<input type="text" class="form-control" name="name" value="<?php echo $list[0]->name; ?>" placeholder="Link">
			</div>

			<div class="form-group">
				<label class="col-form-label">Image <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
				<input type="file" class="form-control dropify" data-height="100" name="image" Title="Choose" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image . '') ?>">
			</div>
		<?php
			break;
		...
		?>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" value="<?php echo $list[0]->alt; ?>" name="alt" placeholder="Image Alt1" required>
			</div>
			<div class="form-group">
				<label class="col-form-label">Image Title1 <span class="text-danger">*</span></label>
				<input type="text" class="form-control" value="<?php echo $list[0]->seo_title; ?>" name="seo_title" placeholder="Image Title1" required>
			</div>

			<div class="form-group">
				<label class="col-form-label">Image Alt2 <span class="text-danger">*</span></label>
				<input type="text" class="form-control" value="<?php echo $list[0]->alt2; ?>" name="alt2" placeholder="Image Alt2" required>
			</div>
			<div class="form-group">
				<label class="col-form-label">Image Title2 <span class="text-danger">*</span></label>
				<input type="text" class="form-control" value="<?php echo $list[0]->seo_title2; ?>" name="seo_title2" placeholder="Image Title2" required>
			</div>

			<div class="form-group">
				<label class="col-form-label">Image Alt3 <span class="text-danger">*</span></label>
				<input type="text" class="form-control" value="<?php echo $list[0]->alt3; ?>" name="alt3" placeholder="Image Alt3" required>
			</div>
			<div class="form-group">
				<label class="col-form-label">Image Title3 <span class="text-danger">*</span></label>
				<input type="text" class="form-control" value="<?php echo $list[0]->seo_title3; ?>" name="seo_title3" placeholder="Image Title3" required>
			</div>

			<div class="form-group">
				<label class="col-form-label">Image Alt4 <span class="text-danger">*</span></label>
				<input type="text" class="form-control" value="<?php echo $list[0]->alt4; ?>" name="alt4" placeholder="Image Alt4" required>
			</div>
			<div class="form-group">
				<label class="col-form-label">Image Title4 <span class="text-danger">*</span></label>
				<input type="text" class="form-control" value="<?php echo $list[0]->seo_title4; ?>" name="seo_title4" placeholder="Image Title4" required>
			</div>

			<div class="form-group">
				<labeel class="col-form-label">Title1 <span class="text-danger">*</span></label>
					<textarea id="summernoteEditor" name="title1" class="form-control summernote">
				<?= $list[0]->title1; ?>                                         
			</textarea>
			</div>
			<div class="form-group">
				<labeel class="col-form-label">SubTitle1 <span class="text-danger">*</span></label>
					<textarea id="summernoteEditor" name="subtitle1" class="form-control summernote">
				<?= $list[0]->subtitle1; ?>                                         
			</textarea>
			</div>
			<div class="form-group">
				<labeel class="col-form-label">Description1 <span class="text-danger">*</span></label>
			...
			<div class="form-group">
				...
				<input type="file" class="form-control dropify" data-height="100" name="image1" Title="Choose" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image1 . '') ?>">
			</div>
			<labeel class="col-form-label">Title2 <span class="text-danger">*</span></label>
				<textarea id="summernoteEditor" name="title2" class="form-control summernote">
            <?= $list[0]->title2; ?>                                         
		</textarea>
				</div>
				<div class="form-group">
					<labeel class="col-form-label">SubTitle2 <span class="text-danger">*</span></label>
						<textarea id="summernoteEditor" name="subtitle2" class="form-control summernote">
            <?= $list[0]->subtitle2; ?>                                         
		</textarea>
				</div>
				<div class="form-group">
					<labeel class="col-form-label">Description2 <span class="text-danger">*</span></label>
			...
			<?= $list[0]->our_values; ?>                        
				...
				<div class="form-group">
					...
					<input type="file" class="form-control dropify" data-height="100" name="image2" Title="Choose" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image2 . '') ?>">
				</div>
				<div class="form-group">
			...
			<?= $list[0]->title3; ?>                         
				...
				<div class="form-group">
					...
					<input type="file" class="form-control dropify" data-height="100" name="image3" Title="Choose" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image3 . '') ?>">
				</div>
				<div class="form-group">
			...
			<?= $list[0]->title4; ?>                             
				...
				<div class="form-group">
					...
					<input type="file" class="form-control dropify" data-height="100" name="image4" Title="Choose" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image4 . '') ?>">
				</div>
				<div class="form-group">
			...
			<?= !empty($list[0]->desc3) ? $list[0]->desc3 : ''; ?> 				 
		</textarea>
				</div>
			...
			<?= !empty($list[0]->desc4) ? $list[0]->desc4 : ''; ?>
		</textarea>
				</div>
				<!--<div class="form-group">
		<label class="col-form-label">Image5 <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
		<input type="file" class="form-control dropify" data-height="100" name="image5" Title="Choose" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<? //php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image5 . '') 
																																																	?>">
	</div>-->
				<div class="form-group">
		...
		case 'EditManageGetApp':
			...
			// EditBecomeaSellerTop 
		case 'EditBecomeaSellerTop':
			?>
				<input type="hidden" name="id" value="<?php echo $list[0]->id; ?>" />
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" value="<?php echo $list[0]->alt; ?>" name="alt" placeholder="Image Alt" required>
				</div>
				<div class="form-group">
					<label class="col-form-label">Image Title <span class="text-danger">*</span></label>
					<input type="text" class="form-control" value="<?php echo $list[0]->seo_title; ?>" name="seo_title" placeholder="Image Title" required>
				</div>

				<div class="form-group">
					<label class="col-form-label">Title <span class="text-danger">*</span></label>
					<input type="text" class="form-control" value="<?php echo $list[0]->name; ?>" name="name" placeholder="Title" required>
				</div>
			...
			// EditBecomeaSellerBottom 
		case 'EditBecomeaSellerBottom':
			?>
				<input type="hidden" name="id" value="<?php echo $list[0]->id; ?>" />
				...
				<div class="form-group">
					<label class="col-form-label">Title <span class="text-danger">*</span></label>
					<input type="text" class="form-control" value="<?php echo $list[0]->title; ?>" name="title" placeholder="Title" required>
				</div>
		...
		case 'EditNewLaunches':
			?>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="subtitle" value="<?= $list[0]->subtitle; ?>" placeholder="Sub Title" required>
				</div>
				<div class="form-group">
					<label class="col-form-label">Description <span class="text-danger">*</span></label>
					<textarea class="form-control summernote" name="description" placeholder="Description">
			<?php echo $list[0]->description; ?>
				...
				<div class="form-group">
					...
					<input type="date" class="form-control" name="date" value="<?= $list[0]->date; ?>" placeholder="Date" required>
				</div>
		...
		case 'EditManageAboutUs':
			?>
				...
				<div class="form-group">
					<label class="col-form-label">Image Alt5 <span class="text-danger">*</span></label>
					<input type="text" class="form-control" value="<?php echo $list[0]->alt5; ?>" name="alt5" placeholder="Image Alt5" required>
				</div>
				<div class="form-group">
					<label class="col-form-label">Image Title5 <span class="text-danger">*</span></label>
					<input type="text" class="form-control" value="<?php echo $list[0]->seo_title5; ?>" name="seo_title5" placeholder="Image Title5" required>
				</div>
			...
			<?php echo $list[0]->meta_keyword; ?>	
				...
				<div class="form-group">
					<label class="col-form-label">Image1 <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
					<input type="file" class="form-control dropify" data-height="100" name="image1" Title="Choose Image1" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image1 . '') ?>">
				</div>
				<div class="form-group">
			...
			<?php echo $list[0]->desc1; ?>	
				...
				<div class="form-group">
					<label class="col-form-label">Image2 <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
					<input type="file" class="form-control dropify" data-height="100" name="image2" Title="Choose Image2" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image2 . '') ?>">
				</div>
				<div class="form-group">
					<label class="col-form-label">Image3 <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
					<input type="file" class="form-control dropify" data-height="100" name="image3" Title="Choose Image3" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image3 . '') ?>">
				</div>
				<div class="form-group">
					<label class="col-form-label">Title3 <span class="text-danger">*</span></label>
			...
			<?php echo $list[0]->desc6; ?>	
				...
				<div class="form-group">
					<label class="col-form-label">Image4 <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
					<input type="file" class="form-control dropify" data-height="100" name="image4" Title="Choose Image4" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image4 . '') ?>">
				</div>
			...
			<?php echo $list[0]->desc8; ?>	
				...
				<div class="form-group">
					<label class="col-form-label">Image5 <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
					<input type="file" class="form-control dropify" data-height="100" name="image5" Title="Choose Image5" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image5 . '') ?>">
				</div>
				<div class="form-group">
		...
		case 'EditManageRewards':
			?>
				...
				<div class="form-group">
					<label class="col-form-label">Image1 <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
					<input type="file" class="form-control dropify" data-height="100" name="image4" Title="Choose Image1" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image1 . '') ?>">
				</div>
				<div class="form-group">
					<label class="col-form-label">Title1 <span class="text-danger">*</span></label>
		...
		case 'EditManageDisclaimer':
			...
			?>
				...
				<div class="form-group">
					<label class="col-form-label">Image Alt2 <span class="text-danger">*</span></label>
					<input type="text" class="form-control" value="<?php echo $list[0]->alt2; ?>" name="alt2" placeholder="Image Alt" required>
				</div>
				<div class="form-group">
					<label class="col-form-label">Image Title2 <span class="text-danger">*</span></label>
					<input type="text" class="form-control" value="<?php echo $list[0]->seo_title2; ?>" name="seo_title2" placeholder="Image Title" required>
				</div>
			...
			<?php echo $list[0]->desc7; ?>		
				...
				<div class="form-group">
					<label class="col-form-label">Image2 <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
					<input type="file" class="form-control dropify" data-height="100" name="image2" Title="Choose Image2" accept="image/jpg,image/gif,image/avif, image/png,image/jpeg, image/gif,image/webp" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image2 . '') ?>">
				</div>
		...
		case 'EditPaymentMethod':
			?>
				<input type="hidden" name="id" value="<?php echo $list[0]->id; ?>" />
				<div class="form-group">
					<label class="col-form-label">Payment Method Title<span class="text-danger">*</span></label>
					<input type="text" value="<?php echo $list[0]->payment_title; ?>" class="form-control" name="payment_title" placeholder="Shopping Guide Title" required>
				</div>
				<div class="form-group">
					<label class="col-form-label">Payment Method Description<span class="text-danger">*</span></label>
					<input type="text" value="<?php echo $list[0]->payment_description; ?>" class="form-control" name="payment_description" placeholder="Shopping Guide Description" required>
				</div>
				<div class="form-group">
					<label class="col-form-label">Payment Method Keyword<span class="text-danger">*</span></label>
					<input type="text" value="<?php echo $list[0]->payment_keyword; ?>" class="form-control" name="payment_keyword" placeholder="Shopping Guide Keyword" required>
				</div>
			...
			// EditRoyalClubSetting 
		case 'EditRoyalClubSetting':
			?>
				<input type="hidden" name="id" value="<?php echo $list[0]->id; ?>" />
				<div class="form-group">
					<label class="col-form-label">Image Alt</label>
					<input type="text" class="form-control" name="alt" placeholder="Image Alt" value="<?php echo $list[0]->alt; ?>">
				</div>
				<div class="form-group">
					<label class="col-form-label">Image Title</label>
					<input type="text" class="form-control" name="seo_title" placeholder="Image Title" value="<?php echo $list[0]->seo_title; ?>">
				</div>
				<div class="form-group">
					<label class="col-form-label">Heading</label>
					<input type="text" class="form-control" name="title" placeholder="Heading" value="<?php echo $list[0]->title; ?>">
				</div>
				<div class="form-group">
					<label class="col-form-label">Short Description</label>
					<textarea class="form-control" name="description" placeholder="Short Description"><?php echo $list[0]->description; ?></textarea>
				</div>
		...
		case 'EditReferEarn':
			?>
				...
				<div class="form-group">
					<label class="col-form-label">Image <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
					<input type="file" class="form-control dropify" data-height="100" name="image" Title="Choose Image" accept="image/jpg,image/gif,image/avif, image/png, image/jpeg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image . '') ?>">
				</div>
		...
		case 'EditChooseYourSize':
				...
				?>
					...
					<div class="form-group">
						...
						<select class="form-control" name="royal_prebookig_status" required>
							<option value="true" <?php if ($list[0]->royal_prebookig_status == 'true') {
														echo 'selected';
													} ?>>Enabled</option>
							<option value="false" <?php if ($list[0]->royal_prebookig_status == 'false') {
														echo 'selected';
													} ?>>Disabled</option>
						</select>
					</div>
			...
			case 'EditCategory';
				...
				<div class="form-group">
					<label class="col-form-label"> Upload Category Image <span class="text-danger">* (20*50 px)<small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
					<input type="file" class="form-control dropify" data-height="100" name="icon" Title="Choose Icon" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->icon . '') ?>">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="click_url" value="<?= $list[0]->click_url ?>" placeholder="https://slickpattern.com/">
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<label class="col-form-label">Meta Title<span class="text-danger">*</span></label>
							<textarea class="form-control" name="meta_tag" placeholder="Meta Title" required><?php echo $list[0]->meta_tag; ?></textarea>
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<label class="col-form-label">Meta Keyword<span class="text-danger">*</span></label>
							<textarea class="form-control" name="meta_keyword" placeholder="Meta Keyword" required><?php echo $list[0]->meta_keyword; ?></textarea>
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<label class="col-form-label">Meta Description<span class="text-danger">*</span></label>
							<textarea class="form-control" name="meta_description" placeholder="Meta Description" required><?php echo $list[0]->meta_description; ?></textarea>
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<label class="col-form-label">Image Heading<span class="text-danger"></span></label>
							<textarea class="form-control" name="heading" placeholder="Image Heading"><?php echo $list[0]->heading; ?></textarea>
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<label class="col-form-label">Image Short Description<span class="text-danger"></span></label>
							<textarea class="form-control summernote" name="description" placeholder="Image Short Description"><?php echo $list[0]->description; ?></textarea>
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<input type="checkbox" name="btn_status" value="true" <?= $list[0]->btn_status == 'true' ? 'checked' : '' ?>> <label class="col-form-label">Show Image Button</label>

						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group" id="buttonNameGroup" style="display: <?= $list[0]->btn_status == 'true' ? 'block' : 'none' ?>;">
							<label class="col-form-label" for="btn_txt">Button Name</label>
							<input type="text" id="btn_txt" name="btn_txt" placeholder="Button Name" value="<?php echo $list[0]->btn_txt; ?>" class="form-control">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="col-form-label">Start Date <span class="text-danger"></span></label>
							<!-- <input type="date" class="form-control" value="<?php echo $list[0]->start_date; ?>" name="start_date" placeholder="Image Title"> -->
							<input type="text" id="startDate" class="form-control datePicker" name="start_date" value="<?php echo $list[0]->start_date; ?>">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="col-form-label">End Date <span class="text-danger"></span></label>
							<!-- <input type="date" class="form-control" value="<?php echo $list[0]->end_date; ?>" name="end_date" placeholder="Image Title"> -->
							<input type="text" id="end_date" class="form-control datePicker" name="end_date" value="<?php echo $list[0]->end_date; ?>">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="col-form-label">Image Alt</label>
							<input type="text" class="form-control" name="alt" placeholder="Image Alt" value="<?php echo $list[0]->alt; ?>" required>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="col-form-label">Image Title</label>
							<input type="text" class="form-control" name="seo_title" placeholder="Image Title" value="<?php echo $list[0]->seo_title; ?>" required>
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="video_url" value="<?php echo $list[0]->video_url; ?>" name="video_url" placeholder="https://www.youtube.com/embed/pVpjtKs9ErQ?si=sW9boFpHnzg4M-jv">
						</div>
					</div>
					<div class="col-sm-4">
						<input type="hidden" name="key" value="Intro Slider" />
						<div class="form-group">
							<label class="col-form-label">Desktop Slider Image <span class="text-danger">* <small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
							<input type="file" class="form-control dropify" data-height="100" name="image" Title="Choose" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg+xml" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image . '') ?>">
					...
					<div class="col-sm-4">
						<input type="hidden" name="key" value="Intro Slider" />
						<div class="form-group">
							<label class="col-form-label"> Mobile Slider Image <span class="text-danger">* <small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
							<input type="file" class="form-control dropify" data-height="100" name="image_mobile" Title="Choose" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg+xml" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image_mobile . '') ?>">
					...
					<div class="col-sm-4">
						<input type="hidden" name="key" value="Intro Slider" />
						<div class="form-group">
							<label class="col-form-label">Tablet Slider Image <span class="text-danger">* <small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
							<input type="file" class="form-control dropify" data-height="100" name="image_tablet" Title="Choose" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg+xml" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image_tablet . '') ?>">
			...
			?>
				...
				<div class="form-group">
					<label class="col-form-label"> Hero Banner Image<small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></label>
					<input type="file" class="form-control dropify" data-height="100" name="image" Title="Choose Image" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image . '') ?>">
					<?php echo form_error("image", "<p class='text-danger' >", "</p>"); ?>
				</div>
			<?php
				break;
			...
			?>
				...
				<div class="form-group">
					...
					<select class="form-control" id="schedule_status" name="schedule_status" required data-parsley-required-message="Please select schedule date" onchange="validate(this)">
						<option value="pending" <?php if ($list->schedule_status == 'pending') {
													echo 'selected';
												} ?>>Pending</option>
						<option value="rejected" <?php if ($list->schedule_status == 'rejected') {
														echo 'selected';
													} ?>>Rejected</option>
						<option value="approved" <?php if ($list->schedule_status == 'approved') {
														echo 'selected';
													} ?>>Approved</option>
					</select>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<select class="form-control " name="sale_type" required>
								...
								<option value="flash_sale" <?php if ($list[0]->sale_type == 'flash_sale') {
																echo 'selected';
															} ?>>Flash Sale</option>
								<option value="live_sale" <?php if ($list[0]->sale_type == 'live_sale') {
																echo 'selected';
															} ?>>Live Sale</option>
								<option value="daily_deal" <?php if ($list[0]->sale_type == 'daily_sale') {
																echo 'selected';
															} ?>>Daily Deal</option>
							</select>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<select class="form-control " name="user_type" required>
								<option selected disabled>-- Select --</option>
								<option value="all" <?php if ($list[0]->user_type == 'all') {
														echo 'selected';
													} ?>>All</option>
								<option value="normal" <?php if ($list[0]->user_type == 'normal') {
															echo 'selected';
														} ?>>Normal</option>
								<option value="royal" <?php if ($list[0]->user_type == 'royal') {
															echo 'selected';
														} ?>>Royal</option>
							</select>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<select class="form-control " name="product_type" required>
								<option selected disabled>-- Select --</option>
								<option value="individual" <?php if ($list[0]->product_type == 'individual') {
																echo 'selected';
															} ?>>Individual</option>
								<option value="combo" <?php if ($list[0]->sale_type == 'combo') {
															echo 'selected';
														} ?>>Look</option>
							</select>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<select class="form-control " name="discount_type" required>
								<option selected disabled>-- Select --</option>
								<option value="percent" <?php if ($list[0]->discount_type == 'percent') {
															echo 'selected';
														} ?>>Percent</option>
								<option value="flat" <?php if ($list[0]->discount_type == 'flat') {
															echo 'selected';
														} ?>>Flat</option>
								<option value="buy_x_get_y" <?php if ($list[0]->discount_type == 'buy_x_get_y') {
																echo 'selected';
															} ?>>Buy-X-get-Y</option>
							</select>
			...
			case 'EditSubCategory';
				?>
					...
					<div class="form-group">
						...
						<select class="text-capitalize form-control" name="cat_tag_id" id="cat_tag_id1" required>
							<option disabled>Select Category Tag</option>
							<?php
							if (!empty($list[0]->cat_tag_id)) {
							?>
								<option value="<?= $list[0]->cat_tag_id ?>" selected><?= $list[0]->tag_name ?></option>
							<?php
							}
							?>
						</select>
					...
					<div class="form-group">
						...
						<select class="text-capitalize form-control" name="size_id" required>
							...
							?>
								<option value="<?= $size->id ?>" <?= $list[0]->size_id == $size->id ? 'selected' : '' ?>><?= $size->size_type ?></option>
							<?php } ?>
				...
				<?php
				break;
			case 'EditCategoryTags';
				?>
					<input type="hidden" name="id" value="<?php echo $list[0]->id; ?>" />
					<div class="form-group">
						<label class="col-form-label">Category<span class="text-danger">*</span></label>
						<select class="text-capitalize form-control" name="cat_id" required>
							<option selected disabled>Select</option>
							<?php
							foreach ($categorylist as $each) {
							?>
								<option <?php if ($each->id == $list[0]->cat_id) {
											echo "selected";
										} ?> value="<?= $each->id ?>"><?= $each->name ?></option>
							<?php } ?>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" value="<?= $list[0]->tag_name ?>" name="tag_name" placeholder="Enter Tag Name" required>
						<?php echo form_error("tag_name", "<p class='text-danger'>", "</p>"); ?>
					</div>
			...
			case 'ApproveCombo';
				?>
					<input type="hidden" name="id" value="<?php echo $list->id; ?>" />
					<div class="">
						<h4 style="font-weight:600;" class="text-danger">Look Details</h4>
					</div>
					<div class="row">
						<div class="col-sm-2">
							<div class="form-group p-0">
					...
					<hr>
					<div class="">
						<h4 style="font-weight:600;" class="text-info">Pricing Details</h4>
					</div>
					<div class="row mb-2">
						<div class="col-sm-4">
							<div class="form-group">
					...
					<hr>
					<div class="">
						<h4 style="font-weight:600;" class="text-warning">Return/Refund/Exchnage Information</h4>
					</div>
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
				...
				?>
					...
					<div class="form-group">
						...
						<select class="form-control " name="usertype" required>
							<option selected disabled>-- Select --</option>
							<option <?php if ($list->user_type == "normal") {
										echo "selected";
									} ?> value="normal">Normal</option>
							<option <?php if ($list->user_type == "royal") {
										echo "selected";
									} ?> value="royal">Royal</option>
							<option <?php if ($list->user_type == "all") {
										echo "selected";
					...
					<div class="form-group">
						...
						<select class="form-control " name="producttype" required>
							<option selected disabled>-- Select --</option>
							<option value="individual" <?php if ($list->product_type == "individual") {
															echo "selected";
														} ?>>Individual</option>
							<option value="combo" <?php if ($list->product_type == "combo") {
														echo "selected";
													} ?>>Combo</option>
						</select>
					...
					<div class="form-group">
						<label class="col-form-label">Banner <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
						<input type="file" class="form-control dropify" data-height="100" name="icon" Title="Choose" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list->icon . '') ?>" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg, image/gif" required>
						<?php echo form_error("icon", "<p class='text-danger' >", "</p>"); ?>
					</div>
					<div class="form-group">
						<label class="col-form-label">Start Date <span class="text-danger">*</span></label>
				...
				?>
					...
					<div class="form-group">
						...
						<select type="text" name="vendorupload" class="form-control" required>
							<option selected disabled>select</option>
							<option value="NA" <?php if ($list[0]->vendor_id == 'NA') {
													echo 'selected';
												} ?>>Slick Pattern</option>
							<?php
							$vendorlist = $this->db->get_where('tbl_vendor', ['is_status' => 'true'])->result();
							if (!empty($vendorlist)) {
								foreach ($vendorlist as $vendor) {
							?>
									<option value="<?= $vendor->id ?>" <?php if ($list[0]->vendor_id == $vendor->id) {
																			echo 'selected';
																		} ?>><?= $vendor->name ?> &nbsp -- &nbsp <?= $vendor->shop_name ?></option>
							<?php
								}
							}
							?>
				...
				?>
					...
					<div class="form-group">
						...
						<select class="form-control " name="type" required>
							<option selected disabled>-- Select --</option>
							<option <?php if ($list[0]->plan_type == "month") {
										echo "selected";
									} ?> value="month">Month</option>
							<option <?php if ($list[0]->plan_type == "year") {
										echo "selected";
			...
			case 'EditChoosePlan':
				?>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" value="<?= $list[0]->title ?>" name="title" placeholder="Enter Benefites Title">
					</div>
					<div class="form-group">
						<label class="col-form-label">Description</label>
						<textarea class="form-control" name="description" placeholder="Enter Description"><?= $list[0]->description; ?></textarea>
					</div>
				<?php
				break;
			...
			case 'Editwhatyouget':
				?>
					...
					<div class="form-group">
						<label class="col-form-label">Title</label>
						<input type="text" class="form-control" value="<?= $list[0]->title ?>" name="title" placeholder="Enter  Title">
					</div>
					<div class="form-group">
						<label class="col-form-label">Description</label>
						<textarea class="form-control" name="description" placeholder="Enter Description"><?= $list[0]->description; ?></textarea>
			...
			case 'EditSubscriptionBenefits';
				?>
					...
					<div class="form-group">
						<label class="col-form-label">Image Alt</label>
						<input type="text" class="form-control" value="<?= $list[0]->alt ?>" name="alt" placeholder="Image Alt" required>
					</div>
					<div class="form-group">
						<label class="col-form-label">Image Title</label>
						<input type="text" class="form-control" value="<?= $list[0]->seo_title ?>" name="seo_title" placeholder="Image Title" required>
					</div>
				...
				?>
					...
					<div class="form-group">
						...
						<select class="text-capitalize form-control" name="size" required>
							<option selected disabled>Select </option>
							<option <?php if ($list[0]->size  == 'XS') {
										echo "selected";
									} ?>>XS</option>
							<option <?php if ($list[0]->size  == 'S') {
										echo "selected";
									} ?>>S</option>
							<option <?php if ($list[0]->size  == 'M') {
										echo "selected";
									} ?>>M</option>
							<option <?php if ($list[0]->size  == 'L') {
										echo "selected";
									} ?>>L</option>
							<option <?php if ($list[0]->size  == 'XL') {
										echo "selected";
									} ?>>XL</option>
							<option <?php if ($list[0]->size  == 'XXL') {
										echo "selected";
									} ?>>XXL</option>
							<option <?php if ($list[0]->size  == 'XXXL') {
										echo "selected";
									} ?>>XXXL</option>
						</select>
					...
					<div class="form-group">
						...
						<input type="file" class="form-control dropify" data-height="100" name="icon" Title="Choose Icon" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image . '') ?>">
						<?php echo form_error("icon", "<p class='text-danger' >", "</p>"); ?>
					</div>
				<?php
				break;
				...
				?>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<select class="form-control " name="producttype" required>
									...
									<option value="combo" <?php if ($list[0]->product_type == 'combo') {
																echo "selected";
															} ?>>Combo</option>
								</select>
								<?php echo form_error("producttype", "<p class='text-danger' >", "</p>"); ?>
							...
							?>
								<div class="form-group">
									...
									<select class="form-control " onchange="apply_type1(this.value)" name="apply_type" required>
										<option selected disabled>-- Select --</option>
										<option value="before" <?php if ($list[0]->apply_type == 'before') {
																	echo "selected";
																} ?>>Before Purchase</option>
										<option value="after" <?php if ($list[0]->apply_type == 'after') {
																	echo "selected";
																} ?>>After Purchase</option>
									</select>
								</div>
							<?php } ?>
							<?php
							...
							<?php if ($list[0]->coupon_type != 'Complementary discount coupons' && $list[0]->coupon_type != 'Free gift with purchase' && $list[0]->coupon_type != 'Free shipping coupon' && $list[0]->coupon_type != 'Buy-one-get-one coupons') { ?>
								<div class="form-group" id="discount_type">
									...
									<select class="form-control " onchange="getType2(this.value)" name="type" id="disType" required>
										<option value="flat" <?php if ($list[0]->type == 'flat') {
																	echo "selected";
																} ?>>Flat</option>
										<option value="percent" <?php if ($list[0]->type == 'percent') {
																	echo "selected";
																} ?>>Percentage</option>
									</select>
								</div>
								<div style="display:none" id="percentdiv2">
									<div class="form-group">
										...
										<input type="number" id="percentdis2" min="0" max="100" step="any" class="form-control " value="<?php if ($list[0]->type == 'percent') {
																																			echo $list[0]->discount;
																																		} ?>" name="percentdis" placeholder="Coupon Discount">
									</div>
								</div>
								<div style="display:none" id="amountdiv2">
									<div class="form-group">
										...
										<input type="number" id="flatdis2" class="form-control " name="discountrs" value="<?php if ($list[0]->type == 'flat') {
																																echo $list[0]->discount;
								...
								<div style="display:none" id="rewarddiv2">
									<div class="form-group">
										...
										<input type="number" id="rewarddis2" class="form-control " name="rewarddis" value="<?php if ($list[0]->type == 'reward') {
																																echo $list[0]->discount;
																															} ?>" placeholder="Coupon Discount">
									</div>
								</div>
						...
						<div class="col-sm-6">
							...
							<div class="form-group">
								<label class="col-form-label">Banner <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
								<input type="file" class="form-control dropify" data-height="100" name="icon" Title="Choose" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->banner . '') ?>">
								<?php echo form_error("icon", "<p class='text-danger' >", "</p>"); ?>
							</div>
						</div>
					</div>
			...
			case 'EditCashBack';
				?>
					...
					<div class="form-group">
						...
						<select class="form-control " name="usertype" required>
							<option selected disabled>-- Select --</option>
							<option <?php if ($list[0]->user_type == "normal") {
										echo "selected";
									} ?> value="normal">Normal</option>
							<option <?php if ($list[0]->user_type == "royal") {
										echo "selected";
									} ?> value="royal">Royal</option>
							<option <?php if ($list[0]->user_type == "all") {
										echo "selected";
									} ?> value="all">All</option>
						</select>
						<?php echo form_error("usertype", "<p class='text-danger' >", "</p>"); ?>
					...
					<div class="form-group">
						...
						<select class="form-control " onchange="getType2(this.value)" id="type" name="type" required>
							<option selected disabled>-- Select --</option>
							<option <?php if ($list[0]->type == "flat") {
										echo "selected";
									} ?> value="flat">Flat</option>
							<option <?php if ($list[0]->type == "percent") {
										echo "selected";
					...
					<div style="display:none" id="percentdiv2">
						<div class="form-group">
							...
							<input type="number" id="percentdis2" min="0" value="<?php if ($list[0]->type == "percent") {
																						echo $list[0]->discount;
																					} ?>" max="100" step="any" class="form-control " name="percentdis" placeholder="Cashback Discount">
					...
					<div style="display:none" id="amountdiv2">
						<div class="form-group">
							...
							<input type="number" id="flatdis2" value="<?php if ($list[0]->type == "flat") {
																			echo $list[0]->discount;
																		} ?>" class="form-control " name="discountrs" placeholder="Cashback Discount">
					...
					<div class="form-group">
						<label class="col-form-label">Banner <span class="text-danger"><small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
						<input type="file" class="form-control dropify" data-height="100" name="icon" Title="Choose" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->icon . '') ?>" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg, image/gif" required>
						<?php echo form_error("icon", "<p class='text-danger' >", "</p>"); ?>
					</div>
					<div class="form-group">
						<label class="col-form-label">Start Date <span class="text-danger">*</span></label>
						...
						<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<select class="form-control chosen-select" name="pincode" required>
									...
									?>
										<option <?php if ($each->pincode == $list[0]->pickup_pincode) {
													echo "selected";
												} ?> value="<?= $each->pincode ?>"><?= $each->pincode ?></option>
									<?php
									}
									?>
								</select>
			...
			case 'EditPurchaseSeller';
				...
				case 'UpdateImageProduct';
					...
					<div class="form-group">
						...
						<input type="file" class="form-control dropify" data-height="100" name="image" Title="Choose Image" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg, image/gif" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $image . '') ?>">
						<?php echo form_error("icon", "<p class='text-danger' >", "</p>"); ?>
					</div>
				<?php
					break;
				...
				?>
					<option <?php if ($list[0]->sale_id == $slist->id) {
								echo "selected";
				...
				?>
					<option <?php if ($list[0]->product_id == $plist->id) {
								echo "selected";
							} ?> value="<?= $plist->id ?>"><?= $plist->name ?> - <?= $plist->reg_sell_price ?> ₹</option>
					<?php
					}
					?>
				</select>
				...
				<?php echo form_error("type", "<p class='text-danger' >", "</p>"); ?>
					...
					<div id="percentdiv2">
						<div class="form-group">
							...
							<input type="number" id="percentdis2" min="0" value="<?php if ($list[0]->type == "percent") {
																						echo $list[0]->discount;
																					} ?>" max="100" step="any" class="form-control " name="percentdis" placeholder="Sale Discount">
							<?php echo form_error("percentdis", "<p class='text-danger' >", "</p>"); ?>
						</div>
					</div>
					<div>
				...
				<input type="number" id="flatdis2"  value="<?php if ($list[0]->type == "flat") {
																echo $list[0]->discount;
															} ?>" class="form-control " name="discountrs" placeholder="Sale Discount" >
				<?php echo form_error("discountrs", "<p class='text-danger' >", "</p>"); ?>
				</div>
			</div-->
					...
					<table class="table table-striped table-bordered dataex-res-configuration" id="tablenew" style="width:100%;">
						<thead>
							<tr>
								...
								<th><?php if ($saledata->discount_type != 'buy_x_get_y') {
										echo 'Sale Price';
									} else {
										echo 'Qty Of X-Y';
									} ?></th>
						...
						<tbody id="tablesaleproduct">
							...
							?>
									<tr style="">
										...
										<td><?php if (!empty($vendorname) and $vendorname != 'NA') {
												echo $vendorname;
											} else {
												echo "Slick Pattern";
											} ?></td>
						...
						<tbody id="tbody">
							...
							?>
								...
								<tr>
									<td><?= $srno ?></td>
									<td>
										<input type="checkbox" name="productid[]" id="checkbox<?= $srno; ?>" value="<?= $item->id ?>">
									</td>
									<td><?= $item->name; ?></td>
									<td><?= $item->price; ?> ₹
				...
				?>
					<div class="row">
						...
						?>
							<div class="col-sm-4">
								<a href="javascript:void()" title="Front view image"><img src="<?= base_url('/uploads/product/') . $datas->front_view_image ?>" style="height:150px; width:150px;" /></a>
								<br><br>

								<center>
									<button title="<?= $datas->id ?>" onclick="EditProductImg('<?= $datas->front_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','front_view_image')" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</button>&nbsp <br /><br />
									<?php
									if (!empty($datas->front_view_image)) {
									?>
										<button title="<?= $datas->id ?>" onclick="DeleteDesignImg('<?= $datas->front_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','front_view_image')" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
									<?php
									}
									?>
								</center><br />
							...
							<div class="col-sm-4">
								<a href="javascript:void()" title="Back view image"><img src="<?= base_url('/uploads/product/') . $datas->back_view_image ?>" style="height:150px; width:150px;" /></a>
								<br><br>

								<center>
									<button title="<?= $datas->id ?>" onclick="EditProductImg('<?= $datas->back_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','back_view_image')" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</button>&nbsp <br /><br />
									<?php
									if (!empty($datas->back_view_image)) {
									?>
										<button title="<?= $datas->id ?>" onclick="DeleteDesignImg('<?= $datas->back_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','back_view_image')" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
									<?php
									}
									?>
								</center><br />
							...
							<div class="col-sm-4">
								<a href="javascript:void()" title="Right view image"><img src="<?= base_url('/uploads/product/') . $datas->rside_view_image ?>" style="height:150px; width:150px;" /></a>
								<br><br>

								<center>
									<button title="<?= $datas->id ?>" onclick="EditProductImg('<?= $datas->rside_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','rside_view_image')" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</button>&nbsp <br /><br />
									<?php
									if (!empty($datas->rside_view_image)) {
									?>
										<button title="<?= $datas->id ?>" onclick="DeleteDesignImg('<?= $datas->rside_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','rside_view_image')" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
									<?php
									}
									?>
								</center><br />
							...
							<div class="col-sm-4">
								<a href="javascript:void()" title="Left view image"><img src="<?= base_url('/uploads/product/') . $datas->lside_view_image ?>" style="height:150px; width:150px;" /></a>
								<br><br>

								<center>
									<button title="<?= $datas->id ?>" onclick="EditProductImg('<?= $datas->lside_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','lside_view_image')" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</button>&nbsp <br /><br />
									<?php
									if (!empty($datas->lside_view_image)) {
									?>
										<button title="<?= $datas->id ?>" onclick="DeleteDesignImg('<?= $datas->lside_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','lside_view_image')" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
									<?php
									}
									?>
								</center><br />
							...
							<div class="col-sm-4">
								<a href="javascript:void()" title="Top view image"><img src="<?= base_url('/uploads/product/') . $datas->top_view_image ?>" style="height:150px; width:150px;" /></a>
								<br><br>

								<center>
									<button title="<?= $datas->id ?>" onclick="EditProductImg('<?= $datas->top_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','top_view_image')" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</button>&nbsp <br /><br />
									<?php
									if (!empty($datas->top_view_image)) {
									?>
										<button title="<?= $datas->id ?>" onclick="DeleteDesignImg('<?= $datas->top_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','top_view_image')" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
									<?php
									}
									?>
								</center><br />
							...
							<div class="col-sm-4">
								<a href="javascript:void()" title="Bottom view image"><img src="<?= base_url('/uploads/product/') . $datas->bottom_view_image ?>" style="height:150px; width:150px;" /></a>
								<br><br>

								<center>
									<button title="<?= $datas->id ?>" onclick="EditProductImg('<?= $datas->bottom_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','bottom_view_image')" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</button>&nbsp <br /><br />
									<?php
									if (!empty($datas->bottom_view_image)) {
									?>
										<button title="<?= $datas->id ?>" onclick="DeleteDesignImg('<?= $datas->bottom_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','bottom_view_image')" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
									<?php
									}
									?>
								</center><br />
							...
							<div class="col-sm-4">
								<a href="javascript:void()" title="Close view image"><img src="<?= base_url('/uploads/product/') . $datas->close_view_image ?>" style="height:150px; width:150px;" /></a>
								<br><br>

								<center>
									<button title="<?= $datas->id ?>" onclick="EditProductImg('<?= $datas->close_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','close_view_image')" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</button>&nbsp <br /><br />
									<?php
									if (!empty($datas->close_view_image)) {
									?>
										<button title="<?= $datas->id ?>" onclick="DeleteDesignImg('<?= $datas->close_view_image ?>','<?= $datas->id ?>','<?= base_url('Admin/ManageProduct/') ?>','close_view_image')" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
									<?php
									}
									?>
								</center><br />
				...
				?>
					...
					if (!empty($imagename)) {
						// var_dump($imagename);
					?>
						<center><img src="<?= base_url('uploads/product/') . $imagename ?>" style="height:100px;" /></center>
					<?php
					}
					?>
					...
					<input type="text" name="image_key" value="<?= $image_key ?>" class="form-control" hidden>
					<div class="form-group">
				...
				?>
					...
					<div class="form-group">
						...
						<select name="subcategory" id="attribute_subcat" class="form-control form-control" required>
							...
							?>
									<option value="<?= $eachsubcat->id ?>" <?php if ($eachsubcat->id == $list->subcategory) {
																				echo "selected";
																			} ?>><?= $eachsubcat->name ?></option>
							<?php }
							} ?>
						</select>
					</div>
					<div class="form-group">
						...
						<select name="attribute_type" class="form-control form-control" required>
							<option value="product_attr" <?php if ($list->attribute_type == 'product_attr') {
																echo 'selected';
															} ?>>Product Attribute</option>
							<option value="expert_attr" <?php if ($list->attribute_type == 'expert_attr') {
															echo 'selected';
														} ?>>Expert Attribute</option>
						</select>
					</div>
					<div class="form-group">
				...
				?>
					...
					if (!empty($list)) { ?>
						<div class="col-sm-12">
							<div>
								<h6 class="sub-heading text-primary">Product Attribute&nbsp;<span class="fa-solid fa-plus btn-toggle"><span></h6>
							</div>
							<div class="row">
				...
				case 'ExpertAttribute';
					...
					if (!empty($list)) { ?>
						<div class="col-sm-12">
							<div>
								<h6 class="sub-heading text-primary">Expert Attribute&nbsp;<span class="fa-solid fa-plus btn-toggle"><span></h6>
							</div>
							<div class="row">
								<?php foreach ($list as $attribute) {
								?>
					...
					?>
							<div class="row">
								...
								<div class="col-sm-4">
									...
									<b class="text-primary"><?= $order->order_status ?></b>
								</div>
							</div><br>
							<div class="row">
									...
									<table class="table table-bordered ">
										...
										<tbody>
											<tr>
												...
												<th>Name</th>
												<td><a href="<?= base_url('Admin/ManageUsers/UserFullDetails/' . $order->userid) ?>"><?= $uDetails->name; ?><?php if ($subscription == 'true') {
																																								echo '&nbsp;<span class="badge bg-warning">Royal</span>';
																																							} ?></a></td>
											</tr>
											<tr>
												<th>Mobile</th>
													...
													if ($product->num_rows() > 0) {
														...
														<tr>
															<form>
																...
																<td>
																	<a href="<?= base_url($this->data->controller . '/ManageProduct/ViewProduct/' . $product->id) ?>"><img src="<?php if (!empty($icons[0])) {
																																													echo base_url('uploads/product/') . $icons[0];
																																												} ?>" height="80" width="80"></a>
																</td>
																<td>
																	<a href="<?= base_url($this->data->controller . '/ManageProduct/ViewProduct/' . $product->id) ?>"><b><?= $product->name; ?></b></a><span class="badge bg-primary"><?php if ($sale == 'true') {
																																																											echo 'Sale';
																																																										} ?></span><br>
																	<?php
								...
								<div class="col-sm-12 table-responsive">
									<table class="table table-bordered mb-1">
										...
										<tbody>
												...
												<th colspan="7">Payment Information&nbsp;
													<span class="badge badge-primary"><?php
																						if ($order->pay_mode == 'online') {
																							...
																							echo "Cash On Delivery(" . $order->pay_mode . ")";
																						} ?>
													</span>
												</th>
											</tr>
											...
											<tr>
												<td>
													<span class="<?php if ($order->PaymentStatus == 'Success') {
																		echo 'text-success' . ' ' . 'font-weight-bold';
																	} else {
																		echo 'text-danger' . ' ' . 'font-weight-bold';
																	} ?>"><?= $order->PaymentStatus ?></span><br>
											...
											<tr>
												<td colspan="5"></td>
												<th>Grand Total</th>
												<td><?php echo "&#8377;" . (((int)$TotalProductPrice + (int)$order->shipping_charge + (int)$giftWrapCharge) - (int)$order->coupon_discount) ?></td>
											</tr>
										</tbody>
									</table>
								</div>
								...
								<div class="col-sm-12 table-responsive">
									<table class="table table-bordered">
										<tbody>
											...
											<tr>
												<th>Address</th>
												<td><?= $address->line1 ?>&nbsp;<?= $address->city ?>&nbsp;<?= $address->state ?>&nbsp;,&nbsp;<?= $address->pincode ?></td>
											</tr>
											<tr>
												<th>Contact Details</th>
												<td><?= $uDetails->mobile; ?> , <?= $uDetails->email; ?></td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="col-sm-12">
								...
								<div class="form-group">
									...
									<select name="return_status" class="form-control form-control" id="type" required="" onchange="getType(this.value)">
										<option selected disabled>Select</option>
										<option value="requested" <?php if (($cart->return_status) == 'requested') {
																		echo 'selected';
																	} ?>>Requested</option>
										<option value="approved" <?php if (($cart->return_status) == 'approved') {
																		echo 'selected';
																	} ?>>Approved</option>
									</select>
								</div>
								...
								<table id="role" class="table role-tble">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<img src="<?php if ($category->add) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											</td>
											<td>
												<img src="<?php if ($category->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($category->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($subscriptionplan->add) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($subscriptionplan->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($subscriptionplan->edit) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($subscriptionplan->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($subscriber->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($subscriber->edit) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($subscriber->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($product->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($attribute->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($attribute->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($lookproduct->add) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($lookproduct->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($lookproduct->edit) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($lookproduct->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($giftwrap->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($giftwrap->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($beautyconsultation->add) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($beautyconsultation->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($beautyconsultation->edit) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($beautyconsultation->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($feedback->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($feedback->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($salemanagement->add) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($salemanagement->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($salemanagement->edit) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($salemanagement->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($ecatlog->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($vendor->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($fashion_expert->add) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($fashion_expert->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($fashion_expert->edit) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($fashion_expert->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($notification->add) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($notification->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($notification->edit) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($notification->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($deliverycharge->add) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($deliverycharge->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($deliverycharge->edit) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($deliverycharge->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($slider->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											<td>Help & Support</td>
											<td>
												<img src="<?php if ($helpandsupport->add) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($helpandsupport->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($helpandsupport->edit) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($helpandsupport->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($contentmanagement->add) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($contentmanagement->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($contentmanagement->edit) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($contentmanagement->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
										...
										<tr>
											...
											<td>
												<img src="<?php if ($businesssettings->add) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($businesssettings->approval) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($businesssettings->edit) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
											...
											<td>
												<img src="<?php if ($businesssettings->delete) {
																echo base_url('public/images/checked.png');
															} else {
																echo base_url('public/images/incorrect.png');
															} ?>" height="20">
									...
									<tbody>
										...
										?>
											...
											<?php if (!empty($list->type)) { ?><tr>
												...
												<tr>
													<th>Discount</th>
													<td><?= $list->discount ?>&nbsp;(Max:<?= $list->max_discount ?>)</td>
												<tr><?php } ?>
												<tr>
													<th>Min Order</th>
												...
												<tr>
													...
													<td><?= base64_decode($list->termsconditions) ?></td>
												<tr>
												<?php } ?>
									<tbody>
								</table>
				...
				?>
					...
					<div class="form-group p-0">
						...
						<select class="form-control" name="type" placeholder="Type" required>
							...
							<option value="product" <?= $list[0]->type == 'product' ? 'selected' : '' ?>>product</option>
							<option value="category" <?= $list[0]->type == 'category' ? 'selected' : '' ?>>category</option>
							<option value="subcategory" <?= $list[0]->type == 'subcategory' ? 'selected' : '' ?>>subcategory</option>
						</select>
						<?php echo form_error("type", "<p class='text-danger' >", "</p>"); ?>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" value="<?= $list[0]->query ?>" name="query" placeholder="Query" required>
					...
					<div class="row">
						...
						<div class="col-sm-6 d-none">
							<div class="form-group p-0">
								<label class="col-form-label">Type <span class="text-danger">*</span></label>
								<select class="form-control" name="type" placeholder="Type" required>
									<option value="<?= $list[0]->type ?>" selected><?= $list[0]->type ?></option>
									<!-- <option value="product" <?= $list[0]->type == 'product' ? 'selected' : '' ?>>product</option> -->
									<!-- <option value="category" <?= $list[0]->type == 'category' ? 'selected' : '' ?>>category</option>
							<option value="subcategory" <?= $list[0]->type == 'subcategory' ? 'selected' : '' ?>>subcategory</option> -->
								</select>
						...
						<div class="<?= $cmp_data->sub_type == 'newOnSlickPattern' || $cmp_data->sub_type == 'ourCombos' ? 'col-sm-12': 'col-sm-6' ?> <?= $cmp_data->sub_type != 'offerSlider' && $cmp_data->sub_type != 'offer' ? 'd-block' : 'd-none' ?>">
							<div class="form-group">
								<label class="col-form-label">Title <span class="text-danger">*</span></label>
								<input type="text" class="form-control" name="title" placeholder="Title" value="<?= $list[0]->title ?>" <?= $cmp_data->sub_type != 'offerSlider' ? 'required' : '' ?>>
							</div>
						</div>
						<div class="col-sm-6 <?= $cmp_data->sub_type != 'offerSlider'  && $cmp_data->sub_type != 'newOnSlickPattern' && $cmp_data->sub_type != 'offer' && $cmp_data->sub_type != 'ourCombos' ? 'd-block' : 'd-none' ?>">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="offer_title" value="<?= $list[0]->offer_title ?>" placeholder="Offer Title">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label class="col-form-label">Start Date <span class="text-danger"></span></label>
								<input type="text" id="startDate" class="form-control datePicker" value="<?= $list[0]->start_date ?>" name="start_date">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label class="col-form-label">End Date <span class="text-danger"></span></label>
								<input type="text" id="end_date" class="form-control datePicker" value="<?= $list[0]->end_date ?>" name="end_date">
							</div>
						</div>
						<div class="col-sm-12 <?= $cmp_data->sub_type == 'offerSlider' || $cmp_data->sub_type == 'newOnSlickPattern' || $cmp_data->sub_type == 'offer' || $cmp_data->sub_type == 'ourCombos' ? 'd-block' : 'd-none' ?>">
							<div class="form-group">
								...
								<input type="url" class="form-control" name="url" value="<?= $list[0]->url ?>" placeholder="https://slickpattern.com/" <?= $cmp_data->sub_type == 'offerSlider' || $cmp_data->sub_type == 'offer' || $cmp_data->sub_type == 'ourCombos' ? 'required' : '' ?>>
							</div>
						</div>
						<div class="col-sm-12 <?= $cmp_data->sub_type != 'offerSlider' && $cmp_data->sub_type != 'newOnSlickPattern' && $cmp_data->sub_type != 'offer' && $cmp_data->sub_type != 'ourCombos' ? 'd-block' : 'd-none' ?>">
							<div class="form-group">
								<label class="col-form-label">Description <span class="text-danger">*</span></label>
								<textarea class="form-control summernote" name="description" placeholder="Description" <?= $cmp_data->sub_type != 'offerSlider' && $cmp_data->sub_type != 'newOnSlickPattern' && $cmp_data->sub_type != 'offer' && $cmp_data->sub_type != 'ourCombos' ? 'required' : '' ?>><?= $list[0]->description ?></textarea>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label class="col-form-label">Image Title <span class="text-danger">*</span></label>
								<input type="text" class="form-control" name="image_title" value="<?= $list[0]->image_title ?>" placeholder="Image Title" required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label class="col-form-label">Image Alt <span class="text-danger">*</span></label>
								<input type="text" class="form-control" name="image_alt" value="<?= $list[0]->image_alt ?>" placeholder="Image Alt" required>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
								<label class="col-form-label">Image <span class="text-danger">*<small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
								<input type="file" class="form-control dropify" data-height="100" id="image" name="image" Title="Choose" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg+xml" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->image . '') ?>">
								<?php echo form_error("image", "<p class='text-danger' >", "</p>"); ?>
							</div>
						</div>
					</div>
				...
				?>
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="form-group">
								<label class="col-form-label">Title <span class="text-danger">*</span></label>
								<input type="text" id="title" class="form-control" value="<?= $list[0]->title ?>" name="title">
							</div>
						</div>
						
						<div class="col-sm-12 <?= $list[0]->sub_type =='aboutUs' ? 'd-block':'d-none'?>">
							<div class="form-group">
								<label class="col-form-label">Heading <span class="text-danger">*</span></label>
								<input type="text" id="heading" class="form-control" value="<?= $list[0]->heading ?>" name="heading">
							</div>
						</div>
						<div class="col-sm-12 <?= $list[0]->sub_type =='aboutUs' ? 'd-block':'d-none'?>">
							<div class="form-group">
								<label class="col-form-label">URL <span class="text-danger">*</span></label>
								<input type="text" id="url" class="form-control" value="<?= $list[0]->url ?>" name="url">
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
								<label class="col-form-label">Description <span class="text-danger">*</span></label>
								<textarea id="description" class="form-control" name="description"><?= $list[0]->description ?></textarea>
							</div>
						</div>
						<div class="col-sm-12 <?= $list[0]->sub_type =='aboutUs' ? 'd-block':'d-none'?>">
							<div class="form-group">
								<label class="col-form-label">Background Image <span class="text-danger">*<small>(.png, .jpeg, .jpg, .webp, .avif, .svg)</small></span></label>
								<input type="file" class="form-control dropify" data-height="100" id="image" name="image" Title="Choose" accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg+xml" data-default-file="<?php echo base_url('uploads/' . $this->data->folder . '/' . $list[0]->bg_image . '') ?>">
								<?php echo form_error("image", "<p class='text-danger' >", "</p>"); ?>
							</div>
						</div>
		...
		<script>
			flatpickr('.datePicker', {
				enableTime: true, // Set to true if you want to include time picker
			...
			$('#btn_status').change(function() {
				if ($(this).is(':checked')) {
					$('#buttonNameGroup').show();
					$('#btn_txt').attr('required', true);
				} else {
					$('#buttonNameGroup').hide();
					$('#btn_txt').removeAttr('required');
				}
			});
		</script>