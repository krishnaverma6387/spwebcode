																...
																<div class="row">
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label for="exampleFormControlTextarea1"><h3>RETURNS TITLE</h3></label>
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label for="exampleFormControlTextarea1"><h3>RETURNS DESCRIPTION</h3></label>
																	...
																	<div class="col-sm-12">
																		<div class="form-group">
																			<label for="exampleFormControlTextarea1"><h3>RETURNS KEYWORD</h3></label>
																	...
																	<div class="col-sm-12">
																		<div class="form-group">
																			<label for="exampleFormControlTextarea1"><h3>RETURNS POLICY</h3></label>
																	...
																	<div class="col-sm-12">
																		<div class="form-group">
																			<label for="exampleFormControlTextarea1"><h3>RETURNS POLICY 2</h3></label>
																			<textarea id="summernoteEditor" name="return_policy2" class="form-control summernote">
																				<?php echo !empty($list->return_policy2) ? $list->return_policy2 : '' ?>
																			</textarea>
																		</div>
																	</div>
