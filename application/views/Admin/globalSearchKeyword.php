                            ...
                            <div class="card card-dashboard">
                                <?php if (($role_type == 'subadmin' && $permission->add) || $role_type == 'admin') { ?>
                                    ...
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#AddModal">
                                        ...
                                        <button class="btn btn-danger" onclick="check('tbl_global_search_keyword')">
                                            <i class="fa fa-trash" aria-hidden="true"></i> Delete Selected</button>
                                            
                                        <a href="<?= base_url('Admin/globalSearchKeyword/Refresh')?>" class="btn btn-success">
                                            <i class="fa fa-refresh" aria-hidden="true"></i> Refresh <?= $this->data->key; ?></a>
                                    </div>
                                <?php } ?>
                                                            ...
                                                            <?php if (($role_type == 'subadmin' && $permission->approval) || $role_type == 'admin') { ?>
                                                                <td>
                                                                    <div class="custom-control custom-switch custom-control-inline">
                                                                        <input type="checkbox" class="custom-control-input" onchange="return Status(this,'<?= $this->data->table; ?>','id','<?= $item->id; ?>','status')" <?php if ($item->status == 'true') {
                                                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                                                } ?> id="switch-id<?= $srno; ?>">
