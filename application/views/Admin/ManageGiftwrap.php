            ...
            <div class="content-wrapper">
                        ...
                        <div class="breadcrumbs-top">
                            ...
                            <div class="breadcrumb-wrapper d-none d-sm-block">
                                <ol class="breadcrumb p-0 mb-0 pl-1">
                                    ...
                                    <li class="breadcrumb-item active"><?= $this->data->key;?></li>       
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <?php 
                    ...
                    if(!empty($this->permissionAuth) && ($this->userData->type=='subadmin')){
                        ...
                        $permission=$this->permissionAuth->giftwrap;
						$role_type='subadmin';
                    }
                ?>
                                            ...
                                            <div class="">
                                                <table class="table table-striped table-bordered dataex-res-configuration" style="width:100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <input type="text" class="form-control text-capitalize" name="price" placeholder="Gift Wrapper/Box Price" required >
                                                        ...
                                                        <input type="file" class="form-control dropify" data-height="100" name="image" Title="Choose" required  accept="image/jpg, image/png, image/jpeg,image/webp,image/avif, image/svg">   <?php echo form_error("icon", "<p class='text-danger' >", "</p>"); ?>
