				...
				<div class="content-header row">
					...
					<div class="content-header-left col-12 mb-2 mt-1">
						...
						<div class="breadcrumbs-top">
							...
							<h5 class="content-header-title float-left pr-1 mb-0">Assign Coupon Product</h5> 
							...
							<div class="breadcrumb-wrapper d-none d-sm-block">
								...
								<ol class="breadcrumb p-0 mb-0 pl-1">
									...
									<li class="breadcrumb-item active"><?= $coupondata->title;?></li>
							...
							<div class="col-sm-12">
								...
								<div class="card card-dashboard">
									<div class="card-header p-1">
										<?php
											if($coupondata->product_type == 'individual')
											{
											?>
											<form action="<?php echo base_url($this->data->controller.'/'.$this->data->method .'/CouponFilterProduct'); ?>" method="post" enctype="multipart/form-data" id="FilterData">
												
												<div class="row mt-2">
													<div class="col-sm-3">
														<div class="form-group">
															<label>User<span class="text-danger"> *</span></label> 
															<select class="form-control select-box" name="user" onchange="change_usertype(this.value,'<?=$coupondata->user_type?>');" data-placeholder="Select User Type">
											...
											{
											?>
											<form action="<?php echo base_url($this->data->controller.'/'.$this->data->method .'/CouponFilterCombo'); ?>" method="post" enctype="multipart/form-data" id="FilterData">
									...
									<div class="card-body table-responsive">
										<form action="<?php echo base_url($this->data->controller.'/'.$this->data->method); ?>/SubmitCouponData" id="SubmitCouponData">
											<input type="hidden" value="<?= $coupondata->id;?>" name="couponid">
											<input type="hidden" value="<?= $coupondata->product_type;?>" name="producttype">
											<div class="row">
														...
														<tbody>
															<?php $srno = 1;
																...
																<tr>
																	...
																	<td>
																		<div class="btn-group">
																			<a href="javascript:void(0);" class="btn btn-sm btn-outline-danger waves-effect waves-light" onclick="return Delete(this,'coupon_product','id','<?= $item->id; ?>','','')"> <i class="fa fa-trash"></i> </a>
																		</div>
																	</td>
																	<?php } ?>
																</tr>
