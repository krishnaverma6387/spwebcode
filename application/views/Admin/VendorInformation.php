			...
			<div class="content-wrapper">
				...
				<div class="content-header row">
					...
					<div class="content-header-left col-12 mb-2 mt-1">
						...
						<div class="breadcrumbs-top">
							...
							<h5 class="content-header-title float-left pr-1 mb-0"><?= $userdata->shop_name; ?> Details</h5>
							...
							<div class="breadcrumb-wrapper d-none d-sm-block">
								...
								<ol class="breadcrumb p-0 mb-0 pl-1">
									...
									<li class="breadcrumb-item active"><?= $userdata->shop_name; ?> Details</li>
				...
				<?php 
                    ...
                    if(!empty($this->permissionAuth) && ($this->userData->type=='subadmin')){
						$permission=$this->permissionAuth->vendor;
						$role_type='subadmin';
					}
				?>
									...
									<div class="col-12">
										<table class="table table-borderless">
											<tbody>
												...
												<tr>
													...
													<td >
														<?php
															...
															{
															?>
															<a href="<?= base_url('uploads/' . $this->data->folder2 . '/' . $userdata->gst_certificate); ?>" target="_blank" download><img src="<?= base_url('uploads/' . $this->data->folder2 . '/' . $userdata->gst_certificate); ?>" alt="users view avatar"
															class="users-avatar-shadow rounded-circle" height="64" width="64"></a>
															<?php
															}
															else
															{
												...
												<tr>
													...
													<td >
														<?php
															if(!empty($userdata->id_proof))
															{
															?>
															<a href="<?= base_url('uploads/' . $this->data->folder2 . '/' . $userdata->id_proof); ?>" target="_blank" download><img src="<?= base_url('uploads/' . $this->data->folder2 . '/' . $userdata->id_proof); ?>" alt="users view avatar"
															class="users-avatar-shadow rounded-circle" height="64" width="64"></a>
															<?php
															}
															else
												...
												<tr>
													...
													<td >
														<?php
															...
															{
															?>
															<a href="<?= base_url('uploads/' . $this->data->folder2 . '/' . $userdata->signature); ?>" target="_blank" download><img src="<?= base_url('uploads/' . $this->data->folder2 . '/' . $userdata->signature); ?>" alt="users view avatar"
															class="users-avatar-shadow rounded-circle" height="64" width="64"></a>
															<?php
															}
															else
										...
										<table class="table table-borderless">
											<tbody>
												...
												<tr>
													<td>Pickup Authority Name :</td>
													<td ><?= $userdata->pickup_name; ?></td>
												</tr>
												<tr>
													<td>Pickup State :</td>
													<td ><?= $userdata->pickup_state; ?></td>
												</tr>
												<tr>
													<td>Pickup City :</td>
													<td ><?= $userdata->pickup_city; ?></td>
												</tr>
												<tr>
													<td>Pickup Area Pincode :</td>
													<td ><?= $userdata->pickup_pincode; ?></td>
												</tr>
												<tr>
													<td>Pickup Address :</td>
													<td ><?= $userdata->pickup_address; ?></td>
												</tr>
