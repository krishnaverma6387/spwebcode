														...
														<?php 
															...
															if (!empty($orders)) {
																foreach ($orders as $data) { 
																	...
																	$cartOrder=$this->db->get_where('tbl_cart',array('orderid'=>$data['orderid'],'is_status'=>'true','order_type'=>'prebooking'))->result();
																	...
																	if(!empty($cartOrder)){	
																		...
																		<tr>
																			...
																			<td><?= $product->name?></td>
																			<td>₹<?php if(!empty($data['prebook_amt'])){echo $data['prebook_amt']; }else{ echo 0;} ?></td>
																			<td><?= $data['orderid'] ?></td>
																			<?php 
																				$bg_color='bg-primary';
																				$toltip_msg='';
