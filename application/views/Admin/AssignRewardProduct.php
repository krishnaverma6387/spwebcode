				...
				<div class="content-header row">
					...
					<div class="content-header-left col-12 mb-2 mt-1">
						...
						<div class="breadcrumbs-top">
							...
							<h5 class="content-header-title float-left pr-1 mb-0">Assign Reward Product</h5> 
							...
							<div class="breadcrumb-wrapper d-none d-sm-block">
								...
								<ol class="breadcrumb p-0 mb-0 pl-1">
									...
									<li class="breadcrumb-item active"><?= $rewarddata->title;?></li>
								</ol>
							</div>
						</div>
					</div>
							...
							<div class="col-sm-12">
								...
								<div class="card card-dashboard">
									...
									<div class="card-header p-1">
										<?php
											if($rewarddata->product_type == 'individual')
											{
											?>
												...
												<div class="row mt-2">
													<div class="col-sm-3">
														<div class="form-group">
															...
															<select class="form-control select-box" name="user" onchange="change_usertype(this.value,'<?=$rewarddata->user_type?>');" data-placeholder="Select User Type">
									...
									<div class="card-body table-responsive">
										<form action="<?php echo base_url($this->data->controller.'/'.$this->data->method); ?>/SubmitRewardData" id="SubmitCouponData">
											<input type="hidden" value="<?= $rewarddata->id;?>" name="rewardid">
											<input type="hidden" value="<?= $rewarddata->product_type;?>" name="producttype">
											<div class="row"> 
														...
														<tbody>
															<?php $srno = 1;
																...
																<tr>
																	...
																	<td>
																		<div class="btn-group">
																			<a href="javascript:void(0);" class="btn btn-sm btn-outline-danger waves-effect waves-light" onclick="return Delete(this,'reward_product','id','<?= $item->id; ?>','','')"> <i class="fa fa-trash"></i> </a>
																		</div>
																	</td>
																	<?php } ?>
																</tr>
