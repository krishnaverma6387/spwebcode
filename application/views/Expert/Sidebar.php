        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
			...
			<li class="nav-item">
				...
				<ul class="menu-content">
					...
					?>
					<?php if (($role_type == 'subadmin' && $permission_product->add) || $role_type == 'admin') { ?><li class="nav-item"><a href="<?= base_url($this->data->controller); ?>/ManageProduct/AddProduct"><i class="feather icon-tag"></i><span class="menu-title">Add Product</span></a></li><?php } ?>
					...
					<?php if (($role_type == 'subadmin' && $permission_attribute->add) || $role_type == 'admin') { ?><li class="nav-item"><a href="<?= base_url($this->data->controller); ?>/ManageAttribute"><i class="feather icon-tag"></i><span class="menu-title">Manage Attribute</span></a></li><?php } ?>
				</ul>
			</li>
			<li class="nav-item">
				...
				<ul class="menu-content">
					...
					?>
					<?php if (($role_type == 'subadmin' && $permission_look->add) || $role_type == 'admin') { ?><li class="nav-item"><a href="<?= base_url($this->data->controller.'/ManageCombo'); ?>"><i class="feather icon-tag"></i><span class="menu-title">Manage Look Product</span></a></li><?php } ?>
					<?php if (($role_type == 'subadmin' && $permission_look->add) || $role_type == 'admin') { ?><li class="nav-item"><a href="<?= base_url($this->data->controller.'/ManageCombo/AddCombo'); ?>"><i class="feather icon-tag"></i><span class="menu-title">Add Look Product</span></a></li><?php } ?>
				</ul>
			</li>
			<li class="nav-item">
			...
			<li class="nav-item">
				...
				<ul class="menu-content">
					<li class="nav-item"><a href="<?= base_url($this->data->controller); ?>/ManageCashback"><i class="feather icon-tag"></i><span class="menu-title">Manage Cashback</span></a></li>
					<li class="nav-item"><a href="<?= base_url($this->data->controller); ?>/ManageCoupon"><i class="feather icon-tag"></i><span class="menu-title">Manage Coupon</span></a></li>
					<li class="nav-item"><a href="<?= base_url($this->data->controller); ?>/ManageRewardPoints"><i class="feather icon-tag"></i><span class="menu-title">Manage Reward Points</span></a></li>
					<li class="nav-item"><a href="<?= base_url($this->data->controller); ?>/RewardPointsSetting"><i class="feather icon-settings"></i><span class="menu-title">Reward Points Setting</span></a></li>
			...
			<li class="nav-item">
				...
				<ul class="menu-content">
					<li class="nav-item"><a href="<?= base_url($this->data->controller); ?>/ManageReview/ProductReview"><i class="feather icon-tag"></i><span class="menu-title">Product Feedback</span></a></li>
					<li class="nav-item"><a href="<?= base_url($this->data->controller); ?>/ManageReview/VendorReview"><i class="feather icon-tag"></i><span class="menu-title">Vendor Feedback</span></a></li>
				</ul>
			</li>
			<li class="nav-item">
				<a href="javascript:void(0);"><i class="feather icon-settings"></i><span class="menu-title">Manage Sale</span></a>
				<ul class="menu-content">
					<li class="nav-item"><a href="<?= base_url($this->data->controller); ?>/ManageSale"><i class="feather icon-tag"></i><span class="menu-title">Manage Sale</span></a></li>
				</ul>
			</li>
			<li class="nav-item">
				<a href="javascript:void(0);"><i class="feather icon-settings"></i><span class="menu-title">Manage Look Book</span></a>
				<ul class="menu-content">
					<li class="nav-item"><a href="<?= base_url($this->data->controller); ?>/ManageECatalog"><i class="feather icon-tag"></i><span class="menu-title">Manage E-Catalog</span></a></li>
				</ul>
			</li>
			<li class="nav-item">
			...
			<li class="nav-item">
				...
				<ul class="menu-content">
					<li><a class="menu-item" href="<?= base_url($this->data->controller); ?>/FaqCategory">Faq Category</a></li>
					<li><a class="menu-item" href="<?= base_url($this->data->controller); ?>/Faqs">Faq's</a></li>
				</ul>
			</li>
			<li class="nav-item">
			...
			<?php if ($this->userData->type != 'subadmin') { ?>
				<li class="nav-item">
					...
					<ul class="menu-content">
						<li><a class="menu-item" href="<?= base_url($this->data->controller); ?>/ManageSubadmin/Create">Add New Subadmin</a></li>
						<li><a class="menu-item" href="<?= base_url($this->data->controller); ?>/ManageSubadmin">Manage Subadmin</a></li>
					</ul>
				</li>
			<?php } ?>
			<li class="nav-item">
				...
				<ul class="menu-content">
					<li><a class="menu-item" href="<?= base_url($this->data->controller); ?>/AccountSettings">My Profile</a></li>
					<?php if ($this->sysAuth == false) : ?>
                    <li><a class="menu-item" href="<?= base_url($this->data->controller); ?>/AccountSettings/UpdateProfile">Update Profile</a></li>
					<?php endif; ?>
					<li><a class="menu-item" href="<?= base_url($this->data->controller); ?>/AccountSettings/ChangePassword">Change Password</a></li>
